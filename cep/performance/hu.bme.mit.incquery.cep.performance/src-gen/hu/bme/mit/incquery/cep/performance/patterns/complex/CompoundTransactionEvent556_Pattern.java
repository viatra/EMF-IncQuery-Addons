...
public class CompoundTransactionEvent556_Pattern extends ParameterizableComplexEventPattern {
  public CompoundTransactionEvent556_Pattern() {
    super();
    ...
    setId("CompoundTransactionEvent556_Pattern");
  }
