...
public class ComponentEMatcher extends BaseMatcher<ComponentEMatch> {
   ...
   * 
   */
  public Collection<ComponentEMatch> getAllMatches(final TransactionComponentE pTe) {
   ...
   * 
   */
  public ComponentEMatch getOneArbitraryMatch(final TransactionComponentE pTe) {
   ...
   * 
   */
  public boolean hasMatch(final TransactionComponentE pTe) {
   ...
   * 
   */
  public int countMatches(final TransactionComponentE pTe) {
   ...
   * 
   */
  public void forEachMatch(final TransactionComponentE pTe, final IMatchProcessor<? super ComponentEMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final TransactionComponentE pTe, final IMatchProcessor<? super ComponentEMatch> processor) {
   ...
   */
  @Deprecated
  public DeltaMonitor<ComponentEMatch> newFilteredDeltaMonitor(final boolean fillAtStart, final TransactionComponentE pTe) {
   ...
   * 
   */
  public ComponentEMatch newMatch(final TransactionComponentE pTe) {
   ...
   * 
   */
  protected Set<TransactionComponentE> rawAccumulateAllValuesOfte(final Object[] parameters) {
    Set<TransactionComponentE> results = new HashSet<TransactionComponentE>();
   ...
   * 
   */
  public Set<TransactionComponentE> getAllValuesOfte() {
  ...
  protected ComponentEMatch tupleToMatch(final Tuple t) {
    try {
    	return new ComponentEMatch.Immutable((hu.bme.mit.incquery.cep.performance.md.metamodels.performancetransaction.TransactionComponentE) t.get(POSITION_TE));	
  ...
  protected ComponentEMatch arrayToMatch(final Object[] match) {
    try {
    	return new ComponentEMatch.Immutable((hu.bme.mit.incquery.cep.performance.md.metamodels.performancetransaction.TransactionComponentE) match[POSITION_TE]);
  ...
  protected ComponentEMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return new ComponentEMatch.Mutable((hu.bme.mit.incquery.cep.performance.md.metamodels.performancetransaction.TransactionComponentE) match[POSITION_TE]);
    } catch(ClassCastException e) {engine.getLogger().error("Element(s) in array not properly typed!",e);	//throw new IncQueryRuntimeException(e.getMessage());
    	return null;
    }
