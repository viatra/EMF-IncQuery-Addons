...
public class CompoundTransactionEvent42_Pattern extends ParameterizableComplexEventPattern {
  public CompoundTransactionEvent42_Pattern() {
    super();
    ...
    setId("CompoundTransactionEvent42_Pattern");
  }
