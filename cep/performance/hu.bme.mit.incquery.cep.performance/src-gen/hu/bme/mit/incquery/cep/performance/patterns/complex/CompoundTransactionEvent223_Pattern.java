...
public class CompoundTransactionEvent223_Pattern extends ParameterizableComplexEventPattern {
  public CompoundTransactionEvent223_Pattern() {
    super();
    ...
    setId("CompoundTransactionEvent223_Pattern");
  }
