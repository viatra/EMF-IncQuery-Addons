...
/**
 * Pattern-specific match representation of the bodymodel.ymca.feetAreApart pattern, 
 * to be used in conjunction with {@link FeetAreApartMatcher}.
 * 
 ...
 * 
 */
public abstract class FeetAreApartMatch extends BasePatternMatch {
  ...
  private FeetAreApartMatch(final LeftFoot pLF, final RightFoot pRF) {
    this.fLF = pLF;
    this.fRF = pRF;
  ...
  public List<String> parameterNames() {
    return FeetAreApartMatch.parameterNames;
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof FeetAreApartMatch)) { // this should be infrequent				
    	if (obj == null)
    		return false;
    ...
    FeetAreApartMatch other = (FeetAreApartMatch) obj;
  ...
  public Pattern pattern() {
    try {
    	return FeetAreApartMatcher.querySpecification().getPattern();
  ...
  static final class Mutable extends FeetAreApartMatch {
  ...
  static final class Immutable extends FeetAreApartMatch {
