...
public class CompoundTransactionEvent606_Pattern extends ParameterizableComplexEventPattern {
  public CompoundTransactionEvent606_Pattern() {
    super();
    ...
    setId("CompoundTransactionEvent606_Pattern");
  }
