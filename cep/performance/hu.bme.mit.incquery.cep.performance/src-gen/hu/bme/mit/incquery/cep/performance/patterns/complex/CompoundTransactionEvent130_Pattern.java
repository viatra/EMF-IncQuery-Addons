...
public class CompoundTransactionEvent130_Pattern extends ParameterizableComplexEventPattern {
  public CompoundTransactionEvent130_Pattern() {
    super();
    ...
    setId("CompoundTransactionEvent130_Pattern");
  }
