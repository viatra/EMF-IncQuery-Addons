...
import org.eclipse.gef3d.examples.uml2.activity.edit.parts.UMLEditPartFactory3D;
import org.eclipse.gef3d.examples.uml2.activity.part.UMLActivityDiagramEditor3D;
...
import org.eclipse.uml2.diagram.activity.providers.UMLEditPartProvider;
 ...
 * @since Apr 7, 2009
 */
public class UMLActivityEditPartProvider3D extends UMLEditPartProvider {
	/**
	 * Logger for this class
	 */
	private static final Logger log = Logger.getLogger(UMLActivityEditPartProvider3D.class.getName());

	
	public static String[] SUPPORTED_EDITORS =
		{ UMLActivityDiagramEditor3D.class.getName() };

	/**
	 * 
	 */
	public UMLActivityEditPartProvider3D() {
