 ...
 * <ul>
 *   <li>{@link hu.bme.mit.incquery.vedl.edl.impl.SamplingAnnotationImpl#getSampling <em>Sampling</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SamplingAnnotationImpl extends AnnotationsImpl implements SamplingAnnotation
{
  ...
  {
    return EdlPackage.Literals.SAMPLING_ANNOTATION;
  }
  ...
  public void setSampling(int newSampling)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EdlPackage.SAMPLING_ANNOTATION__SAMPLING, oldSampling, sampling));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case EdlPackage.SAMPLING_ANNOTATION__SAMPLING:
        return getSampling();
    }
