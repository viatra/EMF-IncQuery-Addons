...
public class UpperArmsInYEvaluator1_1 implements IMatchChecker {
   ...
   */
  private Boolean evaluateXExpressionGenerated(final Float REZ, final Float LSZ, final Float LSX, final Float LSY, final Float RSX, final Float RSZ, final Float REX, final Float LEZ, final Float RSY, final Float REY, final Float LEY, final Float LEX) {
  ...
  public Boolean evaluateXExpression(final Tuple tuple, final Map<String,Integer> tupleNameMap) {
    ...
    return evaluateXExpressionGenerated(REZ, LSZ, LSX, LSY, RSX, RSZ, REX, LEZ, RSY, REY, LEY, LEX);
  }
}
