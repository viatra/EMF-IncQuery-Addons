 ...
 * <ul>
 *   <li>{@link hu.bme.mit.incquery.vedl.edl.FollowsOperatorViaTW#getTimewindow <em>Timewindow</em>}</li>
 * </ul>
 * </p>
 *
 * @see hu.bme.mit.incquery.vedl.edl.EdlPackage#getFollowsOperatorViaTW()
 * @model
 * @generated
 */
public interface FollowsOperatorViaTW extends FollowsOperator
{
   ...
   * @see hu.bme.mit.incquery.vedl.edl.EdlPackage#getFollowsOperatorViaTW_Timewindow()
   * @model
   * @generated
   */
  int getTimewindow();
  ...
  /**
   * Sets the value of the '{@link hu.bme.mit.incquery.vedl.edl.FollowsOperatorViaTW#getTimewindow <em>Timewindow</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
