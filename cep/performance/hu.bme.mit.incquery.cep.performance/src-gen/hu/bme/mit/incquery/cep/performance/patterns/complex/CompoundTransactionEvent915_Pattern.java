...
public class CompoundTransactionEvent915_Pattern extends ParameterizableComplexEventPattern {
  public CompoundTransactionEvent915_Pattern() {
    super();
    ...
    setId("CompoundTransactionEvent915_Pattern");
  }
