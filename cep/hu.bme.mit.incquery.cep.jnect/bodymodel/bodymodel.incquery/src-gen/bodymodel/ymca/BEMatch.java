...
/**
 * Pattern-specific match representation of the bodymodel.ymca.BE pattern, 
 * to be used in conjunction with {@link BEMatcher}.
 * 
 ...
 * 
 */
public abstract class BEMatch extends BasePatternMatch {
  ...
  private BEMatch(final LeftHand pLH, final LeftElbow pLE, final LeftShoulder pLS, final Head pH) {
    this.fLH = pLH;
    this.fLE = pLE;
    this.fLS = pLS;
    this.fH = pH;
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof BEMatch)) { // this should be infrequent				
    	if (obj == null)
    		return false;
  ...
  public Pattern pattern() {
    try {
    	return BEMatcher.querySpecification().getPattern();
  ...
  static final class Mutable extends BEMatch {
  ...
  static final class Immutable extends BEMatch {
