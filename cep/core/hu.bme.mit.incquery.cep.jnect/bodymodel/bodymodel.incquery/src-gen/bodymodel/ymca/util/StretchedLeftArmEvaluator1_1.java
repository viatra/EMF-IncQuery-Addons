...
public class StretchedLeftArmEvaluator1_1 implements IMatchChecker {
   ...
   */
  private Boolean evaluateXExpressionGenerated(final Float LHX, final Float LHY, final Float LEZ, final Float LEY, final Float LSZ, final Float LSX, final Float LHZ, final Float LSY, final Float LEX) {
  ...
  public Boolean evaluateXExpression(final Tuple tuple, final Map<String,Integer> tupleNameMap) {
    ...
    return evaluateXExpressionGenerated(LHX, LHY, LEZ, LEY, LSZ, LSX, LHZ, LSY, LEX);
  }
}
