...
/**
 * Pattern-specific match representation of the hu.bme.mit.incquery.cep.tests.testcasesmqueries.event pattern, 
...
public abstract class EventMatch extends BasePatternMatch {
  ...
  private EventMatch(final Event pE) {
    this.fE = pE;
  ...
  public Pattern pattern() {
    try {
    	return EventMatcher.factory().getPattern();
  ...
  static final class Mutable extends EventMatch {
  ...
  static final class Immutable extends EventMatch {
