...
/**
 * A match processor tailored for the bodymodel.ymca.I pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
public abstract class IProcessor implements IMatchProcessor<IMatch> {
  /**
  ...
  @Override
  public void process(final IMatch match) {
