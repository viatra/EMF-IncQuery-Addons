...
import bodymodel.ymca.util.StretchedLeftArmQuerySpecification;
...
/**
 * Generated pattern matcher API of the bodymodel.ymca.stretchedLeftArm pattern, 
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(IncQueryEngine)}, 
 * e.g. in conjunction with {@link IncQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link StretchedLeftArmMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 * @see StretchedLeftArmQuerySpecification
 * 
 */
public class StretchedLeftArmMatcher extends BaseMatcher<StretchedLeftArmMatch> {
  /**
   ...
   * 
   */
  public static StretchedLeftArmMatcher on(final IncQueryEngine engine) throws IncQueryException {
    // check if matcher already exists
    StretchedLeftArmMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = new StretchedLeftArmMatcher(engine);
   ...
   */
  @Deprecated
  public StretchedLeftArmMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   */
  @Deprecated
  public StretchedLeftArmMatcher(final IncQueryEngine engine) throws IncQueryException {
   ...
   * @return matches represented as a StretchedLeftArmMatch object.
   * 
   */
  public Collection<StretchedLeftArmMatch> getAllMatches(final LeftHand pLH, final LeftElbow pLE, final LeftShoulder pLS) {
   ...
   * @param pLE the fixed value of pattern parameter LE, or null if not bound.
   * @param pLS the fixed value of pattern parameter LS, or null if not bound.
   * @return a match represented as a StretchedLeftArmMatch object, or null if no match is found.
   * 
   */
  public StretchedLeftArmMatch getOneArbitraryMatch(final LeftHand pLH, final LeftElbow pLE, final LeftShoulder pLS) {
   ...
   * 
   */
  public void forEachMatch(final LeftHand pLH, final LeftElbow pLE, final LeftShoulder pLS, final IMatchProcessor<? super StretchedLeftArmMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final LeftHand pLH, final LeftElbow pLE, final LeftShoulder pLS, final IMatchProcessor<? super StretchedLeftArmMatch> processor) {
   ...
   */
  @Deprecated
  public DeltaMonitor<StretchedLeftArmMatch> newFilteredDeltaMonitor(final boolean fillAtStart, final LeftHand pLH, final LeftElbow pLE, final LeftShoulder pLS) {
   ...
   * 
   */
  public StretchedLeftArmMatch newMatch(final LeftHand pLH, final LeftElbow pLE, final LeftShoulder pLS) {
    return new StretchedLeftArmMatch.Immutable(pLH, pLE, pLS);
   ...
   * 
   */
  public Set<LeftHand> getAllValuesOfLH(final StretchedLeftArmMatch partialMatch) {
   ...
   * 
   */
  public Set<LeftElbow> getAllValuesOfLE(final StretchedLeftArmMatch partialMatch) {
   ...
   * 
   */
  public Set<LeftShoulder> getAllValuesOfLS(final StretchedLeftArmMatch partialMatch) {
  ...
  @Override
  protected StretchedLeftArmMatch tupleToMatch(final Tuple t) {
    try {
    	return new StretchedLeftArmMatch.Immutable((org.jnect.bodymodel.LeftHand) t.get(POSITION_LH), (org.jnect.bodymodel.LeftElbow) t.get(POSITION_LE), (org.jnect.bodymodel.LeftShoulder) t.get(POSITION_LS));	
  ...
  @Override
  protected StretchedLeftArmMatch arrayToMatch(final Object[] match) {
    try {
    	return new StretchedLeftArmMatch.Immutable((org.jnect.bodymodel.LeftHand) match[POSITION_LH], (org.jnect.bodymodel.LeftElbow) match[POSITION_LE], (org.jnect.bodymodel.LeftShoulder) match[POSITION_LS]);
  ...
  @Override
  protected StretchedLeftArmMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return new StretchedLeftArmMatch.Mutable((org.jnect.bodymodel.LeftHand) match[POSITION_LH], (org.jnect.bodymodel.LeftElbow) match[POSITION_LE], (org.jnect.bodymodel.LeftShoulder) match[POSITION_LS]);
    } catch(ClassCastException e) {engine.getLogger().error("Element(s) in array not properly typed!",e);	//throw new IncQueryRuntimeException(e.getMessage());
    	return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<StretchedLeftArmMatcher> querySpecification() throws IncQueryException {
    return StretchedLeftArmQuerySpecification.instance();
  }
}
