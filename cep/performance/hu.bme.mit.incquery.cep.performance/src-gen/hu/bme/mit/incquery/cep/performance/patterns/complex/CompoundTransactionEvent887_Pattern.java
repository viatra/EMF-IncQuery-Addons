...
public class CompoundTransactionEvent887_Pattern extends ParameterizableComplexEventPattern {
  public CompoundTransactionEvent887_Pattern() {
    super();
    ...
    setId("CompoundTransactionEvent887_Pattern");
  }
