...
/**
 * A match processor tailored for the bodymodel.ymca.A pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
public abstract class AProcessor implements IMatchProcessor<AMatch> {
  /**
  ...
  @Override
  public void process(final AMatch match) {
