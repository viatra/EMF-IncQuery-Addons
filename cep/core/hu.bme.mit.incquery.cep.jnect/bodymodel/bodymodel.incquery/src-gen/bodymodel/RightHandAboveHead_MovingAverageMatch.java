...
/**
 * Pattern-specific match representation of the bodymodel.RightHandAboveHead_MovingAverage pattern, 
 * to be used in conjunction with {@link RightHandAboveHead_MovingAverageMatcher}.
 * 
 ...
 * 
 */
public abstract class RightHandAboveHead_MovingAverageMatch extends BasePatternMatch {
  ...
  private RightHandAboveHead_MovingAverageMatch(final RightHand pRH, final Head pH) {
    this.fRH = pRH;
    this.fH = pH;
  ...
  public List<String> parameterNames() {
    return RightHandAboveHead_MovingAverageMatch.parameterNames;
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof RightHandAboveHead_MovingAverageMatch)) { // this should be infrequent				
    	if (obj == null)
    		return false;
    ...
    RightHandAboveHead_MovingAverageMatch other = (RightHandAboveHead_MovingAverageMatch) obj;
  ...
  public Pattern pattern() {
    try {
    	return RightHandAboveHead_MovingAverageMatcher.querySpecification().getPattern();
  ...
  static final class Mutable extends RightHandAboveHead_MovingAverageMatch {
  ...
  static final class Immutable extends RightHandAboveHead_MovingAverageMatch {
