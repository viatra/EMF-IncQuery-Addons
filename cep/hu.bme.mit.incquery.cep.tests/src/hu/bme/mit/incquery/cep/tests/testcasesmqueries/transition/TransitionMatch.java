...
/**
 * Pattern-specific match representation of the hu.bme.mit.incquery.cep.tests.testcasesmqueries.transition pattern, 
...
public abstract class TransitionMatch extends BasePatternMatch {
  ...
  public Pattern pattern() {
    try {
    	return TransitionMatcher.factory().getPattern();
