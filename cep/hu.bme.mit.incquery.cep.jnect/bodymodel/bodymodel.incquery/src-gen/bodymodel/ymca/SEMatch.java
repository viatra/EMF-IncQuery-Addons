...
/**
 * Pattern-specific match representation of the bodymodel.ymca.SE pattern, 
...
public abstract class SEMatch extends BasePatternMatch {
  ...
  private SEMatch(final RightHand pRH, final RightElbow pRE, final RightShoulder pRS, final Head pH) {
    this.fRH = pRH;
    this.fRE = pRE;
    this.fRS = pRS;
    this.fH = pH;
  ...
  public Pattern pattern() {
    try {
    	return SEMatcher.querySpecification().getPattern();
  ...
  static final class Mutable extends SEMatch {
  ...
  static final class Immutable extends SEMatch {
