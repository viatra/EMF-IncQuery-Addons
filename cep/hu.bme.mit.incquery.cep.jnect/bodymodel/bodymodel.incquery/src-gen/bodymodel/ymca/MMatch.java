...
/**
 * Pattern-specific match representation of the bodymodel.ymca.M pattern, 
 * to be used in conjunction with {@link MMatcher}.
 * 
 ...
 * 
 */
public abstract class MMatch extends BasePatternMatch {
  ...
  private MMatch(final RightHand pRH, final RightElbow pRE, final RightShoulder pRS, final LeftHand pLH, final LeftElbow pLE, final LeftShoulder pLS, final Head pH) {
    this.fRH = pRH;
    this.fRE = pRE;
    this.fRS = pRS;
    this.fLH = pLH;
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof MMatch)) { // this should be infrequent				
    	if (obj == null)
    		return false;
  ...
  public Pattern pattern() {
    try {
    	return MMatcher.querySpecification().getPattern();
  ...
  static final class Mutable extends MMatch {
  ...
  static final class Immutable extends MMatch {
