...
public abstract class BentRightArmMatch extends BasePatternMatch {
  ...
  private BentRightArmMatch(final RightHand pRH, final RightElbow pRE, final RightShoulder pRS) {
    this.fRH = pRH;
    this.fRE = pRE;
    this.fRS = pRS;
  ...
  public Pattern pattern() {
    try {
    	return BentRightArmMatcher.querySpecification().getPattern();
  ...
  static final class Mutable extends BentRightArmMatch {
  ...
  static final class Immutable extends BentRightArmMatch {
