...
public class UpperArmsInYEvaluator1_1 implements IMatchChecker {
   ...
   */
  private Boolean evaluateXExpressionGenerated(final Float REZ, final Float REX, final Float RSY, final Float LSX, final Float RSZ, final Float RSX, final Float LEY, final Float LSZ, final Float REY, final Float LSY, final Float LEZ, final Float LEX) {
  ...
  public Boolean evaluateXExpression(final Tuple tuple, final Map<String,Integer> tupleNameMap) {
    ...
    return evaluateXExpressionGenerated(REZ, REX, RSY, LSX, RSZ, RSX, LEY, LSZ, REY, LSY, LEZ, LEX);
  }
}
