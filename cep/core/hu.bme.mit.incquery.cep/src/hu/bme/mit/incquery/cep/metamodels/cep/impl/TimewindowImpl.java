 ...
 * <ul>
 *   <li>{@link hu.bme.mit.incquery.cep.metamodels.cep.impl.TimewindowImpl#getLength <em>Length</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TimewindowImpl extends EObjectImpl implements Timewindow {
	...
	protected EClass eStaticClass() {
		return CepPackage.Literals.TIMEWINDOW;
	}
	...
	public void setLength(long newLength) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CepPackage.TIMEWINDOW__LENGTH, oldLength, length));
	}
