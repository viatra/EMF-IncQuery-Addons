...
public class CompoundTransactionEvent869_Pattern extends ParameterizableComplexEventPattern {
  public CompoundTransactionEvent869_Pattern() {
    super();
    ...
    setId("CompoundTransactionEvent869_Pattern");
  }
