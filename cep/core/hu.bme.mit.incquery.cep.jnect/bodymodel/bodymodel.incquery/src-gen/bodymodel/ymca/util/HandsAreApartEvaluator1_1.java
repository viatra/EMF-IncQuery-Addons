...
public class HandsAreApartEvaluator1_1 implements IMatchChecker {
   ...
   */
  private Boolean evaluateXExpressionGenerated(final Float RHX, final Float LHZ, final Float RHZ, final Float LHX, final Float LHY, final Float RHY) {
  ...
  public Boolean evaluateXExpression(final Tuple tuple, final Map<String,Integer> tupleNameMap) {
    ...
    return evaluateXExpressionGenerated(RHX, LHZ, RHZ, LHX, LHY, RHY);
  }
}
