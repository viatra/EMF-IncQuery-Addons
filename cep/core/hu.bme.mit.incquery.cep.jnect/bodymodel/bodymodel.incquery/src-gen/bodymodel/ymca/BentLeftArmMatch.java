...
/**
 * Pattern-specific match representation of the bodymodel.ymca.bentLeftArm pattern, 
 * to be used in conjunction with {@link BentLeftArmMatcher}.
 * 
 ...
 * 
 */
public abstract class BentLeftArmMatch extends BasePatternMatch {
  ...
  private BentLeftArmMatch(final LeftHand pLH, final LeftElbow pLE, final LeftShoulder pLS) {
    this.fLH = pLH;
    this.fLE = pLE;
    this.fLS = pLS;
  ...
  public List<String> parameterNames() {
    return BentLeftArmMatch.parameterNames;
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof BentLeftArmMatch)) { // this should be infrequent				
    	if (obj == null)
    		return false;
    ...
    BentLeftArmMatch other = (BentLeftArmMatch) obj;
  ...
  public Pattern pattern() {
    try {
    	return BentLeftArmMatcher.querySpecification().getPattern();
  ...
  static final class Mutable extends BentLeftArmMatch {
  ...
  static final class Immutable extends BentLeftArmMatch {
