...
public class StretchedLeftArmEvaluator1_1 implements IMatchChecker {
   ...
   */
  private Boolean evaluateXExpressionGenerated(final Float LSZ, final Float LEX, final Float LEY, final Float LHY, final Float LSX, final Float LEZ, final Float LHX, final Float LSY, final Float LHZ) {
  ...
  public Boolean evaluateXExpression(final Tuple tuple, final Map<String,Integer> tupleNameMap) {
    ...
    return evaluateXExpressionGenerated(LSZ, LEX, LEY, LHY, LSX, LEZ, LHX, LSY, LHZ);
  }
}
