...
/**
 * A xbase xexpression evaluator tailored for the bodymodel.ymca.feetAreApart pattern.
 */
public class FeetAreApartEvaluator1_1 implements IMatchChecker {
  /**
   * The raw java code generated from the xbase xexpression by xtext.
   */
  private Boolean evaluateXExpressionGenerated(final Float RFZ, final Float LFX, final Float RFY, final Float LFZ, final Float RFX, final Float LFY) {
  ...
  public Boolean evaluateXExpression(final Tuple tuple, final Map<String,Integer> tupleNameMap) {
    ...
    return evaluateXExpressionGenerated(RFZ, LFX, RFY, LFZ, RFX, LFY);
  }
}
