 ...
 * <ul>
 *   <li>{@link hu.bme.mit.incquery.cep.casestudy.transaction.ComponentC#getSupplierId <em>Supplier Id</em>}</li>
 * </ul>
 * </p>
 *
 * @see hu.bme.mit.incquery.cep.casestudy.transaction.TransactionPackage#getComponentC()
 * @model
 * @generated
 */
public interface ComponentC extends Component {
	 ...
	 * @see hu.bme.mit.incquery.cep.casestudy.transaction.TransactionPackage#getComponentC_SupplierId()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link hu.bme.mit.incquery.cep.casestudy.transaction.ComponentC#getSupplierId <em>Supplier Id</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
