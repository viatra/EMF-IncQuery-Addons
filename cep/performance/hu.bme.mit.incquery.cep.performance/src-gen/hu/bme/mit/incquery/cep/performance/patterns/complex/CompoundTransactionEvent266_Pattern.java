...
public class CompoundTransactionEvent266_Pattern extends ParameterizableComplexEventPattern {
  public CompoundTransactionEvent266_Pattern() {
    super();
    ...
    setId("CompoundTransactionEvent266_Pattern");
  }
