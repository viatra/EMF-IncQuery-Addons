 ...
 * <ul>
 *   <li>{@link hu.bme.mit.incquery.metamodels.cep.ManagedPatternRepository#getEventPatterns <em>Event Patterns</em>}</li>
 * </ul>
 * </p>
 *
 * @see hu.bme.mit.incquery.metamodels.cep.CepPackage#getManagedPatternRepository()
 * @model
 * @generated
 */
public interface ManagedPatternRepository extends EObject {
	 ...
	 * @see hu.bme.mit.incquery.metamodels.cep.CepPackage#getManagedPatternRepository_EventPatterns()
