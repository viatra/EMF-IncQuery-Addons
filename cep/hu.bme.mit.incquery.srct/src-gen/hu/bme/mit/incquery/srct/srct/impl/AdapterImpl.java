 ...
 * <ul>
 *   <li>{@link hu.bme.mit.incquery.srct.srct.impl.AdapterImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AdapterImpl extends MinimalEObjectImpl.Container implements Adapter
{
  ...
  {
    return SrctPackage.Literals.ADAPTER;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SrctPackage.ADAPTER__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SrctPackage.ADAPTER__NAME:
        return getName();
    }
