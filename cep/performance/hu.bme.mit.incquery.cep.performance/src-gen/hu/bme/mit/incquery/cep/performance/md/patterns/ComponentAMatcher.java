...
public class ComponentAMatcher extends BaseMatcher<ComponentAMatch> {
   ...
   * 
   */
  public Collection<ComponentAMatch> getAllMatches(final Object pTe) {
   ...
   * 
   */
  public ComponentAMatch getOneArbitraryMatch(final Object pTe) {
   ...
   * 
   */
  public void forEachMatch(final Object pTe, final IMatchProcessor<? super ComponentAMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final Object pTe, final IMatchProcessor<? super ComponentAMatch> processor) {
   ...
   */
  @Deprecated
  public DeltaMonitor<ComponentAMatch> newFilteredDeltaMonitor(final boolean fillAtStart, final Object pTe) {
   ...
   * 
   */
  public ComponentAMatch newMatch(final Object pTe) {
  ...
  protected ComponentAMatch tupleToMatch(final Tuple t) {
    try {
    	return new ComponentAMatch.Immutable((java.lang.Object) t.get(POSITION_TE));	
  ...
  protected ComponentAMatch arrayToMatch(final Object[] match) {
    try {
    	return new ComponentAMatch.Immutable((java.lang.Object) match[POSITION_TE]);
  ...
  protected ComponentAMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return new ComponentAMatch.Mutable((java.lang.Object) match[POSITION_TE]);
    } catch(ClassCastException e) {engine.getLogger().error("Element(s) in array not properly typed!",e);	//throw new IncQueryRuntimeException(e.getMessage());
    	return null;
    }
