...
public class CompoundTransactionEvent192_Pattern extends ParameterizableComplexEventPattern {
  public CompoundTransactionEvent192_Pattern() {
    super();
    ...
    setId("CompoundTransactionEvent192_Pattern");
  }
