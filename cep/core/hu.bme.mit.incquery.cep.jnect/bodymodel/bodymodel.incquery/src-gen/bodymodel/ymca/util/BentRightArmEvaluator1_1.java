...
public class BentRightArmEvaluator1_1 implements IMatchChecker {
   ...
   */
  private Boolean evaluateXExpressionGenerated(final Float RSZ, final Float RHX, final Float REZ, final Float RHY, final Float REY, final Float RSX, final Float RHZ, final Float REX, final Float RSY) {
  ...
  public Boolean evaluateXExpression(final Tuple tuple, final Map<String,Integer> tupleNameMap) {
    ...
    return evaluateXExpressionGenerated(RSZ, RHX, REZ, RHY, REY, RSX, RHZ, REX, RSY);
  }
}
