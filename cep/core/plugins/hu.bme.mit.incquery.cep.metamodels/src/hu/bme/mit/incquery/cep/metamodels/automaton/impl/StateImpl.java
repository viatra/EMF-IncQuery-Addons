 ...
 * <ul>
 *   <li>{@link hu.bme.mit.incquery.cep.metamodels.automaton.impl.StateImpl#getInTransitions <em>In Transitions</em>}</li>
 *   <li>{@link hu.bme.mit.incquery.cep.metamodels.automaton.impl.StateImpl#getOutTransitions <em>Out Transitions</em>}</li>
 *   <li>{@link hu.bme.mit.incquery.cep.metamodels.automaton.impl.StateImpl#getLabel <em>Label</em>}</li>
 *   <li>{@link hu.bme.mit.incquery.cep.metamodels.automaton.impl.StateImpl#getEventTokens <em>Event Tokens</em>}</li>
 *   <li>{@link hu.bme.mit.incquery.cep.metamodels.automaton.impl.StateImpl#getLastProcessedEvent <em>Last Processed Event</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
