...
public class CompoundTransactionEvent873_Pattern extends ParameterizableComplexEventPattern {
  public CompoundTransactionEvent873_Pattern() {
    super();
    ...
    setId("CompoundTransactionEvent873_Pattern");
  }
