...
public class UpperArmsInYEvaluator1_1 implements IMatchChecker {
   ...
   */
  private Boolean evaluateXExpressionGenerated(final Float REZ, final Float LEX, final Float LEZ, final Float LSZ, final Float LSY, final Float LEY, final Float REY, final Float REX, final Float RSY, final Float RSX, final Float RSZ, final Float LSX) {
  ...
  public Boolean evaluateXExpression(final Tuple tuple, final Map<String,Integer> tupleNameMap) {
    ...
    return evaluateXExpressionGenerated(REZ, LEX, LEZ, LSZ, LSY, LEY, REY, REX, RSY, RSX, RSZ, LSX);
  }
}
