...
public class EventPatternLanguageSemanticSequencer extends XbaseSemanticSequencer {
		...
		if(semanticObject.eClass().getEPackage() == EventPatternLanguagePackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			...
			case EventPatternLanguagePackage.ATOMIC_EVENT:
				if(context == grammarAccess.getAbstractAtomicEventRule() ||
				   ...
				   context == grammarAccess.getEventModelElementsRule()) {
			...
			case EventPatternLanguagePackage.SOURCE:
				if(context == grammarAccess.getEventModelElementsRule() ||
	...
	protected void sequence_Adapter(EObject context, Adapter semanticObject) {
		...
		feeder.accept(grammarAccess.getAdapterAccess().getNameSTRINGTerminalRuleCall_0(), semanticObject.getName());
		feeder.finish();
	}
	...
	protected void sequence_ContextAnnotation(EObject context, ContextAnnotation semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, EventPatternLanguagePackage.Literals.CONTEXT_ANNOTATION__CONTEXT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, EventPatternLanguagePackage.Literals.CONTEXT_ANNOTATION__CONTEXT));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
	...
	/**
	 * Constraint:
	 *     (packageName=QualifiedName? usages+=Usage* annotations+=Annotations* name=ID events+=EventModelElements*)
	 */
	...
	protected void sequence_EventParamWithType(EObject context, EventParamWithType semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, EventPatternLanguagePackage.Literals.EVENT_PARAM_WITH_TYPE__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, EventPatternLanguagePackage.Literals.EVENT_PARAM_WITH_TYPE__NAME));
			if(transientValues.isValueTransient(semanticObject, EventPatternLanguagePackage.Literals.EVENT_PARAM_WITH_TYPE__TYPE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, EventPatternLanguagePackage.Literals.EVENT_PARAM_WITH_TYPE__TYPE));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
	...
	protected void sequence_EventWithFollowsOperator(EObject context, EventWithFollowsOperator semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, EventPatternLanguagePackage.Literals.EVENT_WITH_FOLLOWS_OPERATOR__OPERATOR) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, EventPatternLanguagePackage.Literals.EVENT_WITH_FOLLOWS_OPERATOR__OPERATOR));
			if(transientValues.isValueTransient(semanticObject, EventPatternLanguagePackage.Literals.EVENT_WITH_FOLLOWS_OPERATOR__EVENT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, EventPatternLanguagePackage.Literals.EVENT_WITH_FOLLOWS_OPERATOR__EVENT));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
	...
	protected void sequence_IQPatternEvent(EObject context, IQPatternEvent semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, EventPatternLanguagePackage.Literals.EVENT_MODEL_ELEMENTS__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, EventPatternLanguagePackage.Literals.EVENT_MODEL_ELEMENTS__NAME));
			if(transientValues.isValueTransient(semanticObject, EventPatternLanguagePackage.Literals.IQ_PATTERN_EVENT__IQPATTERN) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, EventPatternLanguagePackage.Literals.IQ_PATTERN_EVENT__IQPATTERN));
			if(transientValues.isValueTransient(semanticObject, EventPatternLanguagePackage.Literals.IQ_PATTERN_EVENT__CHANGE_TYPE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, EventPatternLanguagePackage.Literals.IQ_PATTERN_EVENT__CHANGE_TYPE));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
	...
	protected void sequence_ParameterFilter(EObject context, ParameterFilter semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, EventPatternLanguagePackage.Literals.PARAMETER_FILTER__ATTRIBUTE_NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, EventPatternLanguagePackage.Literals.PARAMETER_FILTER__ATTRIBUTE_NAME));
			if(transientValues.isValueTransient(semanticObject, EventPatternLanguagePackage.Literals.PARAMETER_FILTER__PARAM_FILTER_RULE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, EventPatternLanguagePackage.Literals.PARAMETER_FILTER__PARAM_FILTER_RULE));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
	...
	protected void sequence_PriorityAnnotation(EObject context, PriorityAnnotation semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, EventPatternLanguagePackage.Literals.PRIORITY_ANNOTATION__PRIORITY) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, EventPatternLanguagePackage.Literals.PRIORITY_ANNOTATION__PRIORITY));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
	...
	protected void sequence_SamplingAnnotation(EObject context, SamplingAnnotation semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, EventPatternLanguagePackage.Literals.SAMPLING_ANNOTATION__SAMPLING) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, EventPatternLanguagePackage.Literals.SAMPLING_ANNOTATION__SAMPLING));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
