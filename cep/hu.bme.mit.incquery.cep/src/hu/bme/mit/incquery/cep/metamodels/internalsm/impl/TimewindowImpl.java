 ...
 * <ul>
 *   <li>{@link hu.bme.mit.incquery.cep.metamodels.internalsm.impl.TimewindowImpl#getLength <em>Length</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TimewindowImpl extends EObjectImpl implements Timewindow {
	...
	protected EClass eStaticClass() {
		return InternalsmPackage.Literals.TIMEWINDOW;
	}
	...
	public void setLength(long newLength) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InternalsmPackage.TIMEWINDOW__LENGTH, oldLength, length));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case InternalsmPackage.TIMEWINDOW__LENGTH:
				return getLength();
		}
