...
public class CompoundTransactionEvent324_Pattern extends ParameterizableComplexEventPattern {
  public CompoundTransactionEvent324_Pattern() {
    super();
    ...
    setId("CompoundTransactionEvent324_Pattern");
  }
