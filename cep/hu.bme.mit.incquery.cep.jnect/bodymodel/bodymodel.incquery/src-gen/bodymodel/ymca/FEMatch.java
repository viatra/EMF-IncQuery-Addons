...
public abstract class FEMatch extends BasePatternMatch {
  ...
  private FEMatch(final RightHand pRH, final RightElbow pRE, final RightShoulder pRS, final Head pH) {
    this.fRH = pRH;
    this.fRE = pRE;
    this.fRS = pRS;
    this.fH = pH;
  ...
  public Pattern pattern() {
    try {
    	return FEMatcher.querySpecification().getPattern();
  ...
  static final class Mutable extends FEMatch {
  ...
  static final class Immutable extends FEMatch {
