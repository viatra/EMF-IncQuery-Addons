...
public class CompoundTransactionEvent731_Pattern extends ParameterizableComplexEventPattern {
  public CompoundTransactionEvent731_Pattern() {
    super();
    ...
    setId("CompoundTransactionEvent731_Pattern");
  }
