...
/**
 * A match processor tailored for the bodymodel.ymca.M pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
public abstract class MProcessor implements IMatchProcessor<MMatch> {
  /**
  ...
  @Override
  public void process(final MMatch match) {
