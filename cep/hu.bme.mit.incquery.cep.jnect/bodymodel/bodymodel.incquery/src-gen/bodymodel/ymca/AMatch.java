...
/**
 * Pattern-specific match representation of the bodymodel.ymca.A pattern, 
 * to be used in conjunction with {@link AMatcher}.
 * 
 ...
 * 
 */
public abstract class AMatch extends BasePatternMatch {
  ...
  private AMatch(final RightHand pRH, final RightElbow pRE, final RightShoulder pRS, final LeftHand pLH, final LeftElbow pLE, final LeftShoulder pLS, final Head pH) {
    this.fRH = pRH;
    this.fRE = pRE;
    this.fRS = pRS;
    this.fLH = pLH;
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof AMatch)) { // this should be infrequent				
    	if (obj == null)
    		return false;
  ...
  public Pattern pattern() {
    try {
    	return AMatcher.querySpecification().getPattern();
  ...
  static final class Mutable extends AMatch {
  ...
  static final class Immutable extends AMatch {
