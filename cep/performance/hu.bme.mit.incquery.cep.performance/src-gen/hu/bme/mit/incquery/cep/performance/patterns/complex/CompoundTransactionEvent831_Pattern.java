...
public class CompoundTransactionEvent831_Pattern extends ParameterizableComplexEventPattern {
  public CompoundTransactionEvent831_Pattern() {
    super();
    ...
    setId("CompoundTransactionEvent831_Pattern");
  }
