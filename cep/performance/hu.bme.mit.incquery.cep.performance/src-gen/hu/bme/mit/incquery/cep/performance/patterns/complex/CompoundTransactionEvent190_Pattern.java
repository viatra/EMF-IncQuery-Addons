...
public class CompoundTransactionEvent190_Pattern extends ParameterizableComplexEventPattern {
  public CompoundTransactionEvent190_Pattern() {
    super();
    ...
    setId("CompoundTransactionEvent190_Pattern");
  }
