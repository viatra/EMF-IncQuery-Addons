...
public class FeetAreApartEvaluator1_1 implements IMatchChecker {
   ...
   */
  private Boolean evaluateXExpressionGenerated(final Float LFZ, final Float RFX, final Float LFX, final Float LFY, final Float RFZ, final Float RFY) {
  ...
  public Boolean evaluateXExpression(final Tuple tuple, final Map<String,Integer> tupleNameMap) {
    ...
    return evaluateXExpressionGenerated(LFZ, RFX, LFX, LFY, RFZ, RFY);
  }
}
