...
public class BentRightArmMatcher extends BaseMatcher<BentRightArmMatch> {
   ...
   * 
   */
  public Collection<BentRightArmMatch> getAllMatches(final RightHand pRH, final RightElbow pRE, final RightShoulder pRS) {
   ...
   * 
   */
  public BentRightArmMatch getOneArbitraryMatch(final RightHand pRH, final RightElbow pRE, final RightShoulder pRS) {
   ...
   * 
   */
  public void forEachMatch(final RightHand pRH, final RightElbow pRE, final RightShoulder pRS, final IMatchProcessor<? super BentRightArmMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final RightHand pRH, final RightElbow pRE, final RightShoulder pRS, final IMatchProcessor<? super BentRightArmMatch> processor) {
   ...
   */
  @Deprecated
  public DeltaMonitor<BentRightArmMatch> newFilteredDeltaMonitor(final boolean fillAtStart, final RightHand pRH, final RightElbow pRE, final RightShoulder pRS) {
   ...
   * 
   */
  public BentRightArmMatch newMatch(final RightHand pRH, final RightElbow pRE, final RightShoulder pRS) {
    return new BentRightArmMatch.Immutable(pRH, pRE, pRS);
  ...
  protected BentRightArmMatch tupleToMatch(final Tuple t) {
    try {
    	return new BentRightArmMatch.Immutable((org.jnect.bodymodel.RightHand) t.get(POSITION_RH), (org.jnect.bodymodel.RightElbow) t.get(POSITION_RE), (org.jnect.bodymodel.RightShoulder) t.get(POSITION_RS));	
  ...
  protected BentRightArmMatch arrayToMatch(final Object[] match) {
    try {
    	return new BentRightArmMatch.Immutable((org.jnect.bodymodel.RightHand) match[POSITION_RH], (org.jnect.bodymodel.RightElbow) match[POSITION_RE], (org.jnect.bodymodel.RightShoulder) match[POSITION_RS]);
  ...
  protected BentRightArmMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return new BentRightArmMatch.Mutable((org.jnect.bodymodel.RightHand) match[POSITION_RH], (org.jnect.bodymodel.RightElbow) match[POSITION_RE], (org.jnect.bodymodel.RightShoulder) match[POSITION_RS]);
    } catch(ClassCastException e) {engine.getLogger().error("Element(s) in array not properly typed!",e);	//throw new IncQueryRuntimeException(e.getMessage());
    	return null;
    }
