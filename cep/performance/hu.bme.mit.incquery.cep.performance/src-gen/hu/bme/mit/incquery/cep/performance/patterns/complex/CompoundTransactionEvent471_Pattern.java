...
public class CompoundTransactionEvent471_Pattern extends ParameterizableComplexEventPattern {
  public CompoundTransactionEvent471_Pattern() {
    super();
    ...
    setId("CompoundTransactionEvent471_Pattern");
  }
