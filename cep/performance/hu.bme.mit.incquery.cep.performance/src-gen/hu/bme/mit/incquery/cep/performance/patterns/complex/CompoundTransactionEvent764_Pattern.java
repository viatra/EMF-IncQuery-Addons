...
public class CompoundTransactionEvent764_Pattern extends ParameterizableComplexEventPattern {
  public CompoundTransactionEvent764_Pattern() {
    super();
    ...
    setId("CompoundTransactionEvent764_Pattern");
  }
