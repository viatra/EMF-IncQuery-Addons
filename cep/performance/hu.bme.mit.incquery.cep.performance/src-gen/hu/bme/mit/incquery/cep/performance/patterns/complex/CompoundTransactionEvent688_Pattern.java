...
public class CompoundTransactionEvent688_Pattern extends ParameterizableComplexEventPattern {
  public CompoundTransactionEvent688_Pattern() {
    super();
    ...
    setId("CompoundTransactionEvent688_Pattern");
  }
