...
public class StretchedLeftArmEvaluator1_1 implements IMatchChecker {
   ...
   */
  private Boolean evaluateXExpressionGenerated(final Float LSX, final Float LHZ, final Float LEX, final Float LSZ, final Float LEZ, final Float LHX, final Float LEY, final Float LSY, final Float LHY) {
  ...
  public Boolean evaluateXExpression(final Tuple tuple, final Map<String,Integer> tupleNameMap) {
    ...
    return evaluateXExpressionGenerated(LSX, LHZ, LEX, LSZ, LEZ, LHX, LEY, LSY, LHY);
  }
}
