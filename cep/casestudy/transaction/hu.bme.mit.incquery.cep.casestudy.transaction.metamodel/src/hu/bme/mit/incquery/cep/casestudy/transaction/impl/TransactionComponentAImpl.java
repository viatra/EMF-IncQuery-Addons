 ...
 * <ul>
 *   <li>{@link hu.bme.mit.incquery.cep.casestudy.transaction.impl.TransactionComponentAImpl#getCustomerId <em>Customer Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class TransactionComponentAImpl extends ComponentImpl implements TransactionComponentA {
	/**
	 ...
	 * @generated
	 */
	protected TransactionComponentAImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return TransactionPackage.Literals.TRANSACTION_COMPONENT_A;
	}
	...
	public void setCustomerId(String newCustomerId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TransactionPackage.TRANSACTION_COMPONENT_A__CUSTOMER_ID, oldCustomerId, customerId));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TransactionPackage.TRANSACTION_COMPONENT_A__CUSTOMER_ID:
