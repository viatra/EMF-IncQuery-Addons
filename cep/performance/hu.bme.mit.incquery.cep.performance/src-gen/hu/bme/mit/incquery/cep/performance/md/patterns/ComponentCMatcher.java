...
public class ComponentCMatcher extends BaseMatcher<ComponentCMatch> {
   ...
   * 
   */
  public Collection<ComponentCMatch> getAllMatches(final Object pTe) {
   ...
   * 
   */
  public ComponentCMatch getOneArbitraryMatch(final Object pTe) {
   ...
   * 
   */
  public void forEachMatch(final Object pTe, final IMatchProcessor<? super ComponentCMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final Object pTe, final IMatchProcessor<? super ComponentCMatch> processor) {
   ...
   */
  @Deprecated
  public DeltaMonitor<ComponentCMatch> newFilteredDeltaMonitor(final boolean fillAtStart, final Object pTe) {
   ...
   * 
   */
  public ComponentCMatch newMatch(final Object pTe) {
  ...
  protected ComponentCMatch tupleToMatch(final Tuple t) {
    try {
    	return new ComponentCMatch.Immutable((java.lang.Object) t.get(POSITION_TE));	
  ...
  protected ComponentCMatch arrayToMatch(final Object[] match) {
    try {
    	return new ComponentCMatch.Immutable((java.lang.Object) match[POSITION_TE]);
  ...
  protected ComponentCMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return new ComponentCMatch.Mutable((java.lang.Object) match[POSITION_TE]);
    } catch(ClassCastException e) {engine.getLogger().error("Element(s) in array not properly typed!",e);	//throw new IncQueryRuntimeException(e.getMessage());
    	return null;
    }
