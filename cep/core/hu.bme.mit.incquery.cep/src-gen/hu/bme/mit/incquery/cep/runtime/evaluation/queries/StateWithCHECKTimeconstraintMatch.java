...
/**
 * Pattern-specific match representation of the hu.bme.mit.incquery.cep.runtime.evaluation.queries.stateWithCHECKTimeconstraint pattern, 
 * to be used in conjunction with {@link StateWithCHECKTimeconstraintMatcher}.
 * 
 ...
 * 
 */
public abstract class StateWithCHECKTimeconstraintMatch extends BasePatternMatch {
  private State fS;
  ...
  private StateWithCHECKTimeconstraintMatch(final State pS, final TimeConstraint pTc) {
    this.fS = pS;
    this.fTc = pTc;
  ...
  public List<String> parameterNames() {
    return StateWithCHECKTimeconstraintMatch.parameterNames;
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof StateWithCHECKTimeconstraintMatch)) { // this should be infrequent				
    	if (obj == null)
    		return false;
    ...
    StateWithCHECKTimeconstraintMatch other = (StateWithCHECKTimeconstraintMatch) obj;
  ...
  public Pattern pattern() {
    try {
    	return StateWithCHECKTimeconstraintMatcher.querySpecification().getPattern();
  ...
  static final class Mutable extends StateWithCHECKTimeconstraintMatch {
  ...
  static final class Immutable extends StateWithCHECKTimeconstraintMatch {
