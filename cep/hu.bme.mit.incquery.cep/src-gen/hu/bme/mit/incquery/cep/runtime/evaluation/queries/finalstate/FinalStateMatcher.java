...
import hu.bme.mit.incquery.cep.runtime.evaluation.queries.finalstate.FinalStateMatcherFactory;
 ...
 * 
 * @see FinalStateMatch
 * @see FinalStateMatcherFactory
 * @see FinalStateProcessor
 * 
 */
public class FinalStateMatcher extends BaseGeneratedMatcher<FinalStateMatch> {
   ...
   * 
   */
  public static IMatcherFactory<FinalStateMatcher> factory() throws IncQueryException {
    return FinalStateMatcherFactory.instance();
  }
}
