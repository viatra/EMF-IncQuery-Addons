 ...
 * <ul>
 *   <li>{@link hu.bme.mit.incquery.cep.casestudy.transaction.impl.ComponentCImpl#getSupplierId <em>Supplier Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ComponentCImpl extends ComponentImpl implements ComponentC {
	/**
	...
	protected EClass eStaticClass() {
		return TransactionPackage.Literals.COMPONENT_C;
	}
	...
	public void setSupplierId(String newSupplierId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TransactionPackage.COMPONENT_C__SUPPLIER_ID, oldSupplierId, supplierId));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TransactionPackage.COMPONENT_C__SUPPLIER_ID:
