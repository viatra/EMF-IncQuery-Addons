...
public class BentRightArmEvaluator1_1 implements IMatchChecker {
   ...
   */
  private Boolean evaluateXExpressionGenerated(final Float RSZ, final Float RSX, final Float RHZ, final Float RSY, final Float REX, final Float REZ, final Float RHY, final Float REY, final Float RHX) {
  ...
  public Boolean evaluateXExpression(final Tuple tuple, final Map<String,Integer> tupleNameMap) {
    ...
    return evaluateXExpressionGenerated(RSZ, RSX, RHZ, RSY, REX, REZ, RHY, REY, RHX);
  }
}
