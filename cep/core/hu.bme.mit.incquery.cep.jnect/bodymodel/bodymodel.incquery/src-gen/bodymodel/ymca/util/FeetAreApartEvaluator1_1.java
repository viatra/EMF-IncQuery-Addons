...
public class FeetAreApartEvaluator1_1 implements IMatchChecker {
   ...
   */
  private Boolean evaluateXExpressionGenerated(final Float RFX, final Float LFX, final Float LFZ, final Float LFY, final Float RFY, final Float RFZ) {
  ...
  public Boolean evaluateXExpression(final Tuple tuple, final Map<String,Integer> tupleNameMap) {
    ...
    return evaluateXExpressionGenerated(RFX, LFX, LFZ, LFY, RFY, RFZ);
  }
}
