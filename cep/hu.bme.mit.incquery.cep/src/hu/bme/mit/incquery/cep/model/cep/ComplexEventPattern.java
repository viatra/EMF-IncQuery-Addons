 ...
 * <ul>
 *   <li>{@link hu.bme.mit.incquery.cep.model.cep.ComplexEventPattern#getOperator <em>Operator</em>}</li>
 *   <li>{@link hu.bme.mit.incquery.cep.model.cep.ComplexEventPattern#getTimewindow <em>Timewindow</em>}</li>
 * </ul>
 * </p>
 *
 * @see hu.bme.mit.incquery.cep.model.cep.CepPackage#getComplexEventPattern()
 * @model
 * @generated
 */
public interface ComplexEventPattern extends AbstractEventPattern {
	 ...
	 * The literals are from the enumeration {@link hu.bme.mit.incquery.cep.model.cep.ComplexOperator}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see hu.bme.mit.incquery.cep.model.cep.CepPackage#getComplexEventPattern_Operator()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link hu.bme.mit.incquery.cep.model.cep.ComplexEventPattern#getOperator <em>Operator</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see hu.bme.mit.incquery.cep.model.cep.CepPackage#getComplexEventPattern_Timewindow()
	...
	/**
	 * Sets the value of the '{@link hu.bme.mit.incquery.cep.model.cep.ComplexEventPattern#getTimewindow <em>Timewindow</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
