...
/**
 * Pattern-specific match representation of the bodymodel.ymca.handsAreClose pattern, 
 * to be used in conjunction with {@link HandsAreCloseMatcher}.
 * 
 ...
 * 
 */
public abstract class HandsAreCloseMatch extends BasePatternMatch {
  ...
  private HandsAreCloseMatch(final LeftHand pLH, final RightHand pRH) {
    this.fLH = pLH;
    this.fRH = pRH;
  ...
  public List<String> parameterNames() {
    return HandsAreCloseMatch.parameterNames;
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof HandsAreCloseMatch)) { // this should be infrequent				
    	if (obj == null)
    		return false;
    ...
    HandsAreCloseMatch other = (HandsAreCloseMatch) obj;
  ...
  public Pattern pattern() {
    try {
    	return HandsAreCloseMatcher.querySpecification().getPattern();
  ...
  static final class Mutable extends HandsAreCloseMatch {
  ...
  static final class Immutable extends HandsAreCloseMatch {
