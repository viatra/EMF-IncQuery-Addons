...
public class HandsAreCloseEvaluator1_1 implements IMatchChecker {
   ...
   */
  private Boolean evaluateXExpressionGenerated(final Float LHX, final Float RHY, final Float RHX, final Float LHZ, final Float RHZ, final Float LHY) {
  ...
  public Boolean evaluateXExpression(final Tuple tuple, final Map<String,Integer> tupleNameMap) {
    ...
    return evaluateXExpressionGenerated(LHX, RHY, RHX, LHZ, RHZ, LHY);
  }
}
