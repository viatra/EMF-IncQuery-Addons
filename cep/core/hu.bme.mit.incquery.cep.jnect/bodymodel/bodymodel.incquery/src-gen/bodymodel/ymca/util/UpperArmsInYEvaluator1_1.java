...
public class UpperArmsInYEvaluator1_1 implements IMatchChecker {
   ...
   */
  private Boolean evaluateXExpressionGenerated(final Float RSY, final Float REX, final Float LSY, final Float LSZ, final Float LEX, final Float REZ, final Float RSZ, final Float RSX, final Float LEZ, final Float LEY, final Float REY, final Float LSX) {
  ...
  public Boolean evaluateXExpression(final Tuple tuple, final Map<String,Integer> tupleNameMap) {
    ...
    return evaluateXExpressionGenerated(RSY, REX, LSY, LSZ, LEX, REZ, RSZ, RSX, LEZ, LEY, REY, LSX);
  }
}
