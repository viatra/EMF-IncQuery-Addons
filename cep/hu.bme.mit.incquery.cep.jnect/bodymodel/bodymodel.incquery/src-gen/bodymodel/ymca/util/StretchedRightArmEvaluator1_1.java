...
public class StretchedRightArmEvaluator1_1 implements IMatchChecker {
   ...
   */
  private Boolean evaluateXExpressionGenerated(final Float RHX, final Float REZ, final Float RHY, final Float REY, final Float RHZ, final Float REX, final Float RSZ, final Float RSX, final Float RSY) {
  ...
  public Boolean evaluateXExpression(final Tuple tuple, final Map<String,Integer> tupleNameMap) {
    ...
    return evaluateXExpressionGenerated(RHX, REZ, RHY, REY, RHZ, REX, RSZ, RSX, RSY);
  }
}
