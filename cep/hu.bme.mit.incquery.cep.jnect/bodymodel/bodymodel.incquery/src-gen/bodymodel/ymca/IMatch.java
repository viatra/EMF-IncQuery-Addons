...
/**
 * Pattern-specific match representation of the bodymodel.ymca.I pattern, 
 * to be used in conjunction with {@link IMatcher}.
 * 
 ...
 * 
 */
public abstract class IMatch extends BasePatternMatch {
  ...
  private IMatch(final RightHand pRH, final RightElbow pRE, final RightShoulder pRS, final Head pH) {
    this.fRH = pRH;
    this.fRE = pRE;
    this.fRS = pRS;
    this.fH = pH;
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof IMatch)) { // this should be infrequent				
    	if (obj == null)
    		return false;
  ...
  public Pattern pattern() {
    try {
    	return IMatcher.querySpecification().getPattern();
  ...
  static final class Mutable extends IMatch {
  ...
  static final class Immutable extends IMatch {
