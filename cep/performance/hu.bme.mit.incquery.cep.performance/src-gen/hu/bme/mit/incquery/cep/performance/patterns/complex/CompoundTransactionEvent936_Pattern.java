...
public class CompoundTransactionEvent936_Pattern extends ParameterizableComplexEventPattern {
  public CompoundTransactionEvent936_Pattern() {
    super();
    ...
    setId("CompoundTransactionEvent936_Pattern");
  }
