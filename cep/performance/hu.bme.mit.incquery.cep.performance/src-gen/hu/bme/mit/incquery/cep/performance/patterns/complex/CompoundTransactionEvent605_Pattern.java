...
public class CompoundTransactionEvent605_Pattern extends ParameterizableComplexEventPattern {
  public CompoundTransactionEvent605_Pattern() {
    super();
    ...
    setId("CompoundTransactionEvent605_Pattern");
  }
