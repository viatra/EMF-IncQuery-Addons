...
import bodymodel.ymca.AMatch;
import bodymodel.ymca.util.AQuerySpecification;
...
/**
 * Generated pattern matcher API of the bodymodel.ymca.A pattern, 
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(IncQueryEngine)}, 
 * e.g. in conjunction with {@link IncQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link AMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 * @see AMatch
 * @see AProcessor
 * @see AQuerySpecification
 * 
 */
public class AMatcher extends BaseMatcher<AMatch> {
  /**
   ...
   * 
   */
  public static AMatcher on(final IncQueryEngine engine) throws IncQueryException {
    // check if matcher already exists
    AMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = new AMatcher(engine);
   ...
   */
  @Deprecated
  public AMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   */
  @Deprecated
  public AMatcher(final IncQueryEngine engine) throws IncQueryException {
   ...
   * @return matches represented as a AMatch object.
   * 
   */
  public Collection<AMatch> getAllMatches(final RightHand pRH, final RightElbow pRE, final RightShoulder pRS, final LeftHand pLH, final LeftElbow pLE, final LeftShoulder pLS, final Head pH) {
   ...
   * @param pLS the fixed value of pattern parameter LS, or null if not bound.
   * @param pH the fixed value of pattern parameter H, or null if not bound.
   * @return a match represented as a AMatch object, or null if no match is found.
   * 
   */
  public AMatch getOneArbitraryMatch(final RightHand pRH, final RightElbow pRE, final RightShoulder pRS, final LeftHand pLH, final LeftElbow pLE, final LeftShoulder pLS, final Head pH) {
   ...
   * 
   */
  public void forEachMatch(final RightHand pRH, final RightElbow pRE, final RightShoulder pRS, final LeftHand pLH, final LeftElbow pLE, final LeftShoulder pLS, final Head pH, final IMatchProcessor<? super AMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final RightHand pRH, final RightElbow pRE, final RightShoulder pRS, final LeftHand pLH, final LeftElbow pLE, final LeftShoulder pLS, final Head pH, final IMatchProcessor<? super AMatch> processor) {
   ...
   */
  @Deprecated
  public DeltaMonitor<AMatch> newFilteredDeltaMonitor(final boolean fillAtStart, final RightHand pRH, final RightElbow pRE, final RightShoulder pRS, final LeftHand pLH, final LeftElbow pLE, final LeftShoulder pLS, final Head pH) {
   ...
   * 
   */
  public AMatch newMatch(final RightHand pRH, final RightElbow pRE, final RightShoulder pRS, final LeftHand pLH, final LeftElbow pLE, final LeftShoulder pLS, final Head pH) {
    return new AMatch.Immutable(pRH, pRE, pRS, pLH, pLE, pLS, pH);
   ...
   * 
   */
  public Set<RightHand> getAllValuesOfRH(final AMatch partialMatch) {
   ...
   * 
   */
  public Set<RightElbow> getAllValuesOfRE(final AMatch partialMatch) {
   ...
   * 
   */
  public Set<RightShoulder> getAllValuesOfRS(final AMatch partialMatch) {
   ...
   * 
   */
  public Set<LeftHand> getAllValuesOfLH(final AMatch partialMatch) {
   ...
   * 
   */
  public Set<LeftElbow> getAllValuesOfLE(final AMatch partialMatch) {
   ...
   * 
   */
  public Set<LeftShoulder> getAllValuesOfLS(final AMatch partialMatch) {
   ...
   * 
   */
  public Set<Head> getAllValuesOfH(final AMatch partialMatch) {
  ...
  @Override
  protected AMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return new AMatch.Mutable((org.jnect.bodymodel.RightHand) match[POSITION_RH], (org.jnect.bodymodel.RightElbow) match[POSITION_RE], (org.jnect.bodymodel.RightShoulder) match[POSITION_RS], (org.jnect.bodymodel.LeftHand) match[POSITION_LH], (org.jnect.bodymodel.LeftElbow) match[POSITION_LE], (org.jnect.bodymodel.LeftShoulder) match[POSITION_LS], (org.jnect.bodymodel.Head) match[POSITION_H]);
    } catch(ClassCastException e) {engine.getLogger().error("Element(s) in array not properly typed!",e);	//throw new IncQueryRuntimeException(e.getMessage());
    	return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<AMatcher> querySpecification() throws IncQueryException {
    return AQuerySpecification.instance();
  }
}
