 ...
 * <ul>
 *   <li>{@link hu.bme.mit.incquery.cep.dsl.eventPatternLanguage.impl.PatternCallParameterListImpl#getParameters <em>Parameters</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PatternCallParameterListImpl extends MinimalEObjectImpl.Container implements PatternCallParameterList
{
  ...
  {
    return EventPatternLanguagePackage.Literals.PATTERN_CALL_PARAMETER_LIST;
  }
  ...
  public EList<PatternCallParameter> getParameters()
  {
    if (parameters == null)
    {
      parameters = new EObjectContainmentEList<PatternCallParameter>(PatternCallParameter.class, this, EventPatternLanguagePackage.PATTERN_CALL_PARAMETER_LIST__PARAMETERS);
    }
    return parameters;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case EventPatternLanguagePackage.PATTERN_CALL_PARAMETER_LIST__PARAMETERS:
