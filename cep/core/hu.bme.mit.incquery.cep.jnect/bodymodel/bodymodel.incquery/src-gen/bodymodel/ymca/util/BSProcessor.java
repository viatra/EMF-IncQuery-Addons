...
/**
 * A match processor tailored for the bodymodel.ymca.BS pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
public abstract class BSProcessor implements IMatchProcessor<BSMatch> {
  /**
  ...
  @Override
  public void process(final BSMatch match) {
