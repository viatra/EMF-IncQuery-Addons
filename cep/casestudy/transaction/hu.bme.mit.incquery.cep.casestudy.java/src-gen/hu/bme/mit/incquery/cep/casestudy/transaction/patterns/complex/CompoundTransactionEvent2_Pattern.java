...
public class CompoundTransactionEvent2_Pattern extends ParameterizableComplexEventPattern {
  public CompoundTransactionEvent2_Pattern() {
    super();
    setOperator(ComplexOperator.ORDERED);
    
    // composition events
    List<EventPattern> compositionEventPatternsForCP = Lists.newArrayList();
    compositionEventPatternsForCP.add(new hu.bme.mit.incquery.cep.casestudy.transaction.patterns.atomic.ComponentB_Pattern());
    compositionEventPatternsForCP.add(new hu.bme.mit.incquery.cep.casestudy.transaction.patterns.atomic.ComponentC_Pattern());
    compositionEventPatternsForCP.add(new hu.bme.mit.incquery.cep.casestudy.transaction.patterns.atomic.ComponentA_Pattern());
    getCompositionEvents().addAll(compositionEventPatternsForCP);
    setId("CompoundTransactionEvent2_Pattern");
  }
