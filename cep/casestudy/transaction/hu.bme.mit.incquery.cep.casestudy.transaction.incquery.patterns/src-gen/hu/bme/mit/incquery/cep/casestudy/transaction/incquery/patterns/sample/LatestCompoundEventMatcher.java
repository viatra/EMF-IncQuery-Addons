...
public class LatestCompoundEventMatcher extends BaseMatcher<LatestCompoundEventMatch> {
   ...
   * 
   */
  public boolean hasMatch(final CompoundTransactionEvent pE) {
   ...
   * 
   */
  public int countMatches(final CompoundTransactionEvent pE) {
   ...
   * 
   */
  protected Set<CompoundTransactionEvent> rawAccumulateAllValuesOfe(final Object[] parameters) {
   ...
   * 
   */
  public Set<CompoundTransactionEvent> getAllValuesOfe() {
