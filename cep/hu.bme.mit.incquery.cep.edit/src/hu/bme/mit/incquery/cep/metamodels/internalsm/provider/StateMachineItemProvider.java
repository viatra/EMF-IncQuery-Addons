...
/**
 * This is the item provider adapter for a {@link hu.bme.mit.incquery.cep.metamodels.internalsm.StateMachine} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StateMachineItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_StateMachine_eventPattern_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_StateMachine_eventPattern_feature", "_UI_StateMachine_type"),
				 InternalsmPackage.Literals.STATE_MACHINE__EVENT_PATTERN,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(InternalsmPackage.Literals.STATE_MACHINE__STATES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(InternalsmPackage.Literals.STATE_MACHINE__STATES,
				 InternalsmFactory.eINSTANCE.createState()));

		newChildDescriptors.add
			(createChildParameter
				(InternalsmPackage.Literals.STATE_MACHINE__STATES,
				 InternalsmFactory.eINSTANCE.createFinalState()));

		newChildDescriptors.add
			(createChildParameter
				(InternalsmPackage.Literals.STATE_MACHINE__STATES,
				 InternalsmFactory.eINSTANCE.createInitState()));

		newChildDescriptors.add
			(createChildParameter
				(InternalsmPackage.Literals.STATE_MACHINE__STATES,
				 InternalsmFactory.eINSTANCE.createTrapState()));
	}
