...
/**
 * Generated pattern matcher API of the bodymodel.ymca.FE pattern, 
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(IncQueryEngine)}, 
 * e.g. in conjunction with {@link IncQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link FEMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 * @see FEMatch
 * @see FEProcessor
 * @see FEQuerySpecification
 * 
 */
public class FEMatcher extends BaseMatcher<FEMatch> {
  /**
   ...
   * 
   */
  public static FEMatcher on(final IncQueryEngine engine) throws IncQueryException {
    // check if matcher already exists
    FEMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = new FEMatcher(engine);
   ...
   */
  @Deprecated
  public FEMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   */
  @Deprecated
  public FEMatcher(final IncQueryEngine engine) throws IncQueryException {
   ...
   * @return matches represented as a FEMatch object.
   * 
   */
  public Collection<FEMatch> getAllMatches(final RightHand pRH, final RightElbow pRE, final RightShoulder pRS, final Head pH) {
   ...
   * @param pRS the fixed value of pattern parameter RS, or null if not bound.
   * @param pH the fixed value of pattern parameter H, or null if not bound.
   * @return a match represented as a FEMatch object, or null if no match is found.
   * 
   */
  public FEMatch getOneArbitraryMatch(final RightHand pRH, final RightElbow pRE, final RightShoulder pRS, final Head pH) {
   ...
   * 
   */
  public void forEachMatch(final RightHand pRH, final RightElbow pRE, final RightShoulder pRS, final Head pH, final IMatchProcessor<? super FEMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final RightHand pRH, final RightElbow pRE, final RightShoulder pRS, final Head pH, final IMatchProcessor<? super FEMatch> processor) {
   ...
   */
  @Deprecated
  public DeltaMonitor<FEMatch> newFilteredDeltaMonitor(final boolean fillAtStart, final RightHand pRH, final RightElbow pRE, final RightShoulder pRS, final Head pH) {
   ...
   * 
   */
  public FEMatch newMatch(final RightHand pRH, final RightElbow pRE, final RightShoulder pRS, final Head pH) {
    return new FEMatch.Immutable(pRH, pRE, pRS, pH);
   ...
   * 
   */
  public Set<RightHand> getAllValuesOfRH(final FEMatch partialMatch) {
   ...
   * 
   */
  public Set<RightElbow> getAllValuesOfRE(final FEMatch partialMatch) {
   ...
   * 
   */
  public Set<RightShoulder> getAllValuesOfRS(final FEMatch partialMatch) {
   ...
   * 
   */
  public Set<Head> getAllValuesOfH(final FEMatch partialMatch) {
  ...
  @Override
  protected FEMatch tupleToMatch(final Tuple t) {
    try {
    	return new FEMatch.Immutable((org.jnect.bodymodel.RightHand) t.get(POSITION_RH), (org.jnect.bodymodel.RightElbow) t.get(POSITION_RE), (org.jnect.bodymodel.RightShoulder) t.get(POSITION_RS), (org.jnect.bodymodel.Head) t.get(POSITION_H));	
  ...
  @Override
  protected FEMatch arrayToMatch(final Object[] match) {
    try {
    	return new FEMatch.Immutable((org.jnect.bodymodel.RightHand) match[POSITION_RH], (org.jnect.bodymodel.RightElbow) match[POSITION_RE], (org.jnect.bodymodel.RightShoulder) match[POSITION_RS], (org.jnect.bodymodel.Head) match[POSITION_H]);
  ...
  @Override
  protected FEMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return new FEMatch.Mutable((org.jnect.bodymodel.RightHand) match[POSITION_RH], (org.jnect.bodymodel.RightElbow) match[POSITION_RE], (org.jnect.bodymodel.RightShoulder) match[POSITION_RS], (org.jnect.bodymodel.Head) match[POSITION_H]);
    } catch(ClassCastException e) {engine.getLogger().error("Element(s) in array not properly typed!",e);	//throw new IncQueryRuntimeException(e.getMessage());
    	return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<FEMatcher> querySpecification() throws IncQueryException {
