...
public class CompoundTransactionEvent864_Pattern extends ParameterizableComplexEventPattern {
  public CompoundTransactionEvent864_Pattern() {
    super();
    ...
    setId("CompoundTransactionEvent864_Pattern");
  }
