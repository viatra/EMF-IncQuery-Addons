 ...
 * <ul>
 *   <li>{@link hu.bme.mit.incquery.cep.dsl.eventPatternLanguage.impl.IQPatternEventImpl#getIqpattern <em>Iqpattern</em>}</li>
 *   <li>{@link hu.bme.mit.incquery.cep.dsl.eventPatternLanguage.impl.IQPatternEventImpl#getChangeType <em>Change Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IQPatternEventImpl extends AbstractAtomicEventImpl implements IQPatternEvent
{
  ...
  {
    return EventPatternLanguagePackage.Literals.IQ_PATTERN_EVENT;
  }
  ...
  public void setIqpattern(String newIqpattern)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EventPatternLanguagePackage.IQ_PATTERN_EVENT__IQPATTERN, oldIqpattern, iqpattern));
  }
  ...
  public void setChangeType(IQPatternChangeType newChangeType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EventPatternLanguagePackage.IQ_PATTERN_EVENT__CHANGE_TYPE, oldChangeType, changeType));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case EventPatternLanguagePackage.IQ_PATTERN_EVENT__IQPATTERN:
        return getIqpattern();
      case EventPatternLanguagePackage.IQ_PATTERN_EVENT__CHANGE_TYPE:
