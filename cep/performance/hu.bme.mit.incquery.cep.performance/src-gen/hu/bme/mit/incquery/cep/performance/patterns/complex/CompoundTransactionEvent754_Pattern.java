...
public class CompoundTransactionEvent754_Pattern extends ParameterizableComplexEventPattern {
  public CompoundTransactionEvent754_Pattern() {
    super();
    ...
    setId("CompoundTransactionEvent754_Pattern");
  }
