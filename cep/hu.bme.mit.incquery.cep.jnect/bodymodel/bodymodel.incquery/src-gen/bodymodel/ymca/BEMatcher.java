...
import bodymodel.ymca.util.BEQuerySpecification;
...
/**
 * Generated pattern matcher API of the bodymodel.ymca.BE pattern, 
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(IncQueryEngine)}, 
 * e.g. in conjunction with {@link IncQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link BEMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 * @see BEMatch
 * @see BEProcessor
 * @see BEQuerySpecification
 * 
 */
public class BEMatcher extends BaseMatcher<BEMatch> {
  /**
   ...
   * 
   */
  public static BEMatcher on(final IncQueryEngine engine) throws IncQueryException {
    // check if matcher already exists
    BEMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = new BEMatcher(engine);
   ...
   */
  @Deprecated
  public BEMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   */
  @Deprecated
  public BEMatcher(final IncQueryEngine engine) throws IncQueryException {
   ...
   * @return matches represented as a BEMatch object.
   * 
   */
  public Collection<BEMatch> getAllMatches(final LeftHand pLH, final LeftElbow pLE, final LeftShoulder pLS, final Head pH) {
   ...
   * @param pLS the fixed value of pattern parameter LS, or null if not bound.
   * @param pH the fixed value of pattern parameter H, or null if not bound.
   * @return a match represented as a BEMatch object, or null if no match is found.
   * 
   */
  public BEMatch getOneArbitraryMatch(final LeftHand pLH, final LeftElbow pLE, final LeftShoulder pLS, final Head pH) {
   ...
   * 
   */
  public void forEachMatch(final LeftHand pLH, final LeftElbow pLE, final LeftShoulder pLS, final Head pH, final IMatchProcessor<? super BEMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final LeftHand pLH, final LeftElbow pLE, final LeftShoulder pLS, final Head pH, final IMatchProcessor<? super BEMatch> processor) {
   ...
   */
  @Deprecated
  public DeltaMonitor<BEMatch> newFilteredDeltaMonitor(final boolean fillAtStart, final LeftHand pLH, final LeftElbow pLE, final LeftShoulder pLS, final Head pH) {
   ...
   * 
   */
  public BEMatch newMatch(final LeftHand pLH, final LeftElbow pLE, final LeftShoulder pLS, final Head pH) {
    return new BEMatch.Immutable(pLH, pLE, pLS, pH);
   ...
   * 
   */
  public Set<LeftHand> getAllValuesOfLH(final BEMatch partialMatch) {
   ...
   * 
   */
  public Set<LeftElbow> getAllValuesOfLE(final BEMatch partialMatch) {
   ...
   * 
   */
  public Set<LeftShoulder> getAllValuesOfLS(final BEMatch partialMatch) {
   ...
   * 
   */
  public Set<Head> getAllValuesOfH(final BEMatch partialMatch) {
  ...
  @Override
  protected BEMatch tupleToMatch(final Tuple t) {
    try {
    	return new BEMatch.Immutable((org.jnect.bodymodel.LeftHand) t.get(POSITION_LH), (org.jnect.bodymodel.LeftElbow) t.get(POSITION_LE), (org.jnect.bodymodel.LeftShoulder) t.get(POSITION_LS), (org.jnect.bodymodel.Head) t.get(POSITION_H));	
  ...
  @Override
  protected BEMatch arrayToMatch(final Object[] match) {
    try {
    	return new BEMatch.Immutable((org.jnect.bodymodel.LeftHand) match[POSITION_LH], (org.jnect.bodymodel.LeftElbow) match[POSITION_LE], (org.jnect.bodymodel.LeftShoulder) match[POSITION_LS], (org.jnect.bodymodel.Head) match[POSITION_H]);
  ...
  @Override
  protected BEMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return new BEMatch.Mutable((org.jnect.bodymodel.LeftHand) match[POSITION_LH], (org.jnect.bodymodel.LeftElbow) match[POSITION_LE], (org.jnect.bodymodel.LeftShoulder) match[POSITION_LS], (org.jnect.bodymodel.Head) match[POSITION_H]);
    } catch(ClassCastException e) {engine.getLogger().error("Element(s) in array not properly typed!",e);	//throw new IncQueryRuntimeException(e.getMessage());
    	return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<BEMatcher> querySpecification() throws IncQueryException {
    return BEQuerySpecification.instance();
  }
}
