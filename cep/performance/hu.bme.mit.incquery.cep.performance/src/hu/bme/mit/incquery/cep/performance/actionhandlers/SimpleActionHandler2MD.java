...
import hu.bme.mit.incquery.cep.performance.md.test.MDPerformanceTester;

import org.eclipse.incquery.runtime.evm.api.Activation;

public class SimpleActionHandler2MD implements IActionHandler {
	...
	public void handle(Activation<? extends IObservableComplexEventPattern> activation) {
		...
		MDPerformanceTester.getInstance().increaseObservedPatternCount();
	}
}
