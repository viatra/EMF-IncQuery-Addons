 ...
 * <ul>
 *   <li>{@link hu.bme.mit.incquery.metamodels.cep.EventProcessingModel#getEventPatterns <em>Event Patterns</em>}</li>
 * </ul>
 * </p>
 *
 * @see hu.bme.mit.incquery.metamodels.cep.CepPackage#getEventProcessingModel()
 * @model
 * @generated
 */
public interface EventProcessingModel extends EObject {
	 ...
	 * @see hu.bme.mit.incquery.metamodels.cep.CepPackage#getEventProcessingModel_EventPatterns()
