...
public class CompoundTransactionEvent379_Pattern extends ParameterizableComplexEventPattern {
  public CompoundTransactionEvent379_Pattern() {
    super();
    ...
    setId("CompoundTransactionEvent379_Pattern");
  }
