...
/**
 * Pattern-specific match representation of the hu.bme.mit.incquery.cep.runtime.evaluation.queries.stateWithSTARTTimeconstraint pattern, 
 * to be used in conjunction with {@link StateWithSTARTTimeconstraintMatcher}.
 * 
...
public abstract class StateWithSTARTTimeconstraintMatch extends BasePatternMatch {
  private State fS;
  ...
  private StateWithSTARTTimeconstraintMatch(final State pS, final TimeConstraint pTc) {
    this.fS = pS;
    this.fTc = pTc;
  ...
  public List<String> parameterNames() {
    return StateWithSTARTTimeconstraintMatch.parameterNames;
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof StateWithSTARTTimeconstraintMatch)) { // this should be infrequent				
    	if (obj == null)
    		return false;
    ...
    StateWithSTARTTimeconstraintMatch other = (StateWithSTARTTimeconstraintMatch) obj;
  ...
  public Pattern pattern() {
    try {
    	return StateWithSTARTTimeconstraintMatcher.querySpecification().getPattern();
  ...
  @SuppressWarnings("all")
  static final class Mutable extends StateWithSTARTTimeconstraintMatch {
  ...
  @SuppressWarnings("all")
  static final class Immutable extends StateWithSTARTTimeconstraintMatch {
