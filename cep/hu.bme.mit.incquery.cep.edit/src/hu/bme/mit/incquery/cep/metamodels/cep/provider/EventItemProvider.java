...
/**
 * This is the item provider adapter for a {@link hu.bme.mit.incquery.cep.metamodels.cep.Event} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EventItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CepPackage.Literals.EVENT__TYPE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CepPackage.Literals.EVENT__TIMESTAMP,
				 true,
				 false,
				 false,
	...
	protected void addEventSourcePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Event_eventSource_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Event_eventSource_feature", "_UI_Event_type"),
				 CepPackage.Literals.EVENT__EVENT_SOURCE,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((Event)object).getType();
