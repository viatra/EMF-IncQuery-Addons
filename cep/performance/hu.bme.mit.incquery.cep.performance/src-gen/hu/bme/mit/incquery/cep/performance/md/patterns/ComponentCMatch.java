...
public abstract class ComponentCMatch extends BasePatternMatch {
  ...
  private ComponentCMatch(final TransactionComponentC pTe) {
    this.fTe = pTe;
  ...
  public boolean set(final String parameterName, final Object newValue) {
    ...
    if ("te".equals(parameterName) ) {
    	this.fTe = (hu.bme.mit.incquery.cep.performance.md.metamodels.performancetransaction.TransactionComponentC) newValue;
    	return true;
    }
    return false;
