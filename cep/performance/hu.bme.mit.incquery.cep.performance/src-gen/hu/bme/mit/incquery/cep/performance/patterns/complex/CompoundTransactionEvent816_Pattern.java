...
public class CompoundTransactionEvent816_Pattern extends ParameterizableComplexEventPattern {
  public CompoundTransactionEvent816_Pattern() {
    super();
    ...
    setId("CompoundTransactionEvent816_Pattern");
  }
