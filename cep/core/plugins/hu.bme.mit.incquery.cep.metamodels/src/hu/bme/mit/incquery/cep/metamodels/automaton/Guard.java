 ...
 * <ul>
 *   <li>{@link hu.bme.mit.incquery.cep.metamodels.automaton.Guard#getEventType <em>Event Type</em>}</li>
 * </ul>
 * </p>
 *
 * @see hu.bme.mit.incquery.cep.metamodels.automaton.AutomatonPackage#getGuard()
 * @model
 * @generated
 */
public interface Guard extends EObject {
     ...
     * @see hu.bme.mit.incquery.cep.metamodels.automaton.AutomatonPackage#getGuard_EventType()
     * @model required="true"
     * @generated
     */
    ...
    /**
     * Sets the value of the '{@link hu.bme.mit.incquery.cep.metamodels.automaton.Guard#getEventType <em>Event Type</em>}' reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
