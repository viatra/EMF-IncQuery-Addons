 ...
 * @see FinishedStateMachineMatcherFactory
 * @see FinishedStateMachineProcessor
 * 
 */
public class FinishedStateMachineMatcher extends BaseGeneratedMatcher<FinishedStateMachineMatch> {
   ...
   * 
   */
  public static IMatcherFactory<FinishedStateMachineMatcher> factory() throws IncQueryException {
    return FinishedStateMachineMatcherFactory.instance();
  }
}
