...
public class HandsAreApartEvaluator1_1 implements IMatchChecker {
   ...
   */
  private Boolean evaluateXExpressionGenerated(final Float RHX, final Float RHY, final Float RHZ, final Float LHX, final Float LHY, final Float LHZ) {
  ...
  public Boolean evaluateXExpression(final Tuple tuple, final Map<String,Integer> tupleNameMap) {
    ...
    return evaluateXExpressionGenerated(RHX, RHY, RHZ, LHX, LHY, LHZ);
  }
}
