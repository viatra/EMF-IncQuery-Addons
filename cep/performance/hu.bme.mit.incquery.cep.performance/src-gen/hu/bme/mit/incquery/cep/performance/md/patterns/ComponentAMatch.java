...
/**
 * Pattern-specific match representation of the hu.bme.mit.incquery.cep.performance.md.patterns.componentA pattern, 
...
public abstract class ComponentAMatch extends BasePatternMatch {
  ...
  private ComponentAMatch(final TransactionComponentA pTe) {
    this.fTe = pTe;
  ...
  public boolean set(final String parameterName, final Object newValue) {
    ...
    if ("te".equals(parameterName) ) {
    	this.fTe = (hu.bme.mit.incquery.cep.performance.md.metamodels.performancetransaction.TransactionComponentA) newValue;
    	return true;
    }
    return false;
  ...
  public String patternName() {
    return "hu.bme.mit.incquery.cep.performance.md.patterns.componentA";
