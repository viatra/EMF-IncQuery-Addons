...
public class UpperArmsInYEvaluator1_1 implements IMatchChecker {
   ...
   */
  private Boolean evaluateXExpressionGenerated(final Float REY, final Float LEZ, final Float RSX, final Float RSZ, final Float LSZ, final Float LSY, final Float LEY, final Float REX, final Float REZ, final Float LSX, final Float LEX, final Float RSY) {
  ...
  public Boolean evaluateXExpression(final Tuple tuple, final Map<String,Integer> tupleNameMap) {
    ...
    return evaluateXExpressionGenerated(REY, LEZ, RSX, RSZ, LSZ, LSY, LEY, REX, REZ, LSX, LEX, RSY);
  }
}
