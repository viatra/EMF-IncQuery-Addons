...
/**
 * Manual modifications go to {hu.bme.mit.incquery.cep.dsl.EventPatternLanguageRuntimeModule}
 */
 @SuppressWarnings("all")
public abstract class AbstractEventPatternLanguageRuntimeModule extends DefaultRuntimeModule {

	protected Properties properties = null;

	@Override
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "hu/bme/mit/incquery/cep/dsl/EventPatternLanguage.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("hu.bme.mit.incquery.cep.dsl.EventPatternLanguage");
	}
	
	public void configureFileExtensions(Binder binder) {
		if (properties == null || properties.getProperty(Constants.FILE_EXTENSIONS) == null)
			binder.bind(String.class).annotatedWith(Names.named(Constants.FILE_EXTENSIONS)).toInstance("vepl");
	}
	
	// contributed by org.eclipse.xtext.generator.grammarAccess.GrammarAccessFragment
	public Class<? extends org.eclipse.xtext.IGrammarAccess> bindIGrammarAccess() {
		return hu.bme.mit.incquery.cep.dsl.services.EventPatternLanguageGrammarAccess.class;
	}

	// contributed by org.eclipse.xtext.generator.serializer.SerializerFragment
	public Class<? extends org.eclipse.xtext.serializer.sequencer.ISemanticSequencer> bindISemanticSequencer() {
		return hu.bme.mit.incquery.cep.dsl.serializer.EventPatternLanguageSemanticSequencer.class;
	}

	// contributed by org.eclipse.xtext.generator.serializer.SerializerFragment
	public Class<? extends org.eclipse.xtext.serializer.sequencer.ISyntacticSequencer> bindISyntacticSequencer() {
		return hu.bme.mit.incquery.cep.dsl.serializer.EventPatternLanguageSyntacticSequencer.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.IParser> bindIParser() {
		return hu.bme.mit.incquery.cep.dsl.parser.antlr.EventPatternLanguageParser.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.antlr.IAntlrTokenFileProvider> bindIAntlrTokenFileProvider() {
		return hu.bme.mit.incquery.cep.dsl.parser.antlr.EventPatternLanguageAntlrTokenFileProvider.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public Class<? extends org.eclipse.xtext.parser.antlr.Lexer> bindLexer() {
		return hu.bme.mit.incquery.cep.dsl.parser.antlr.internal.InternalEventPatternLanguageLexer.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public com.google.inject.Provider<hu.bme.mit.incquery.cep.dsl.parser.antlr.internal.InternalEventPatternLanguageLexer> provideInternalEventPatternLanguageLexer() {
		return org.eclipse.xtext.parser.antlr.LexerProvider.create(hu.bme.mit.incquery.cep.dsl.parser.antlr.internal.InternalEventPatternLanguageLexer.class);
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public void configureRuntimeLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.parser.antlr.LexerBindings.RUNTIME)).to(hu.bme.mit.incquery.cep.dsl.parser.antlr.internal.InternalEventPatternLanguageLexer.class);
	}
	...
	@org.eclipse.xtext.service.SingletonBinding(eager=true)	public Class<? extends hu.bme.mit.incquery.cep.dsl.validation.EventPatternLanguageValidator> bindEventPatternLanguageValidator() {
		return hu.bme.mit.incquery.cep.dsl.validation.EventPatternLanguageValidator.class;
	}
	...
	public Class<? extends org.eclipse.xtext.formatting.IFormatter> bindIFormatter() {
		return hu.bme.mit.incquery.cep.dsl.formatting.EventPatternLanguageFormatter.class;
	}
	...
	public Class<? extends org.eclipse.xtext.xbase.jvmmodel.IJvmModelInferrer> bindIJvmModelInferrer() {
		return hu.bme.mit.incquery.cep.dsl.jvmmodel.EventPatternLanguageJvmModelInferrer.class;
	}
