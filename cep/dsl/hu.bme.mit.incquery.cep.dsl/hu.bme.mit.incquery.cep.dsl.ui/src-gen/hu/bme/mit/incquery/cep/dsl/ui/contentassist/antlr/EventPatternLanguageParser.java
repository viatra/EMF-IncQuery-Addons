		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getModelElementsAccess().getAlternatives(), "rule__ModelElements__Alternatives");
					...
					put(grammarAccess.getEventModelAccess().getGroup(), "rule__EventModel__Group__0");
					put(grammarAccess.getEventModelAccess().getGroup_0(), "rule__EventModel__Group_0__0");
					...
					put(grammarAccess.getEventParameterListAccess().getGroup(), "rule__EventParameterList__Group__0");
					put(grammarAccess.getEventParameterListAccess().getGroup_2(), "rule__EventParameterList__Group_2__0");
					...
					put(grammarAccess.getEventModelAccess().getPackageNameAssignment_0_1(), "rule__EventModel__PackageNameAssignment_0_1");
					put(grammarAccess.getEventModelAccess().getUsagesAssignment_1(), "rule__EventModel__UsagesAssignment_1");
					put(grammarAccess.getEventModelAccess().getNameAssignment_3(), "rule__EventModel__NameAssignment_3");
					put(grammarAccess.getEventModelAccess().getEventsAssignment_5(), "rule__EventModel__EventsAssignment_5");
					...
					put(grammarAccess.getAtomicEventAccess().getNameAssignment_1(), "rule__AtomicEvent__NameAssignment_1");
					put(grammarAccess.getAtomicEventAccess().getParametersAssignment_3(), "rule__AtomicEvent__ParametersAssignment_3");
					put(grammarAccess.getAtomicEventAccess().getSourceAssignment_8(), "rule__AtomicEvent__SourceAssignment_8");
					put(grammarAccess.getAtomicEventAccess().getStaticBindingsAssignment_11(), "rule__AtomicEvent__StaticBindingsAssignment_11");
					put(grammarAccess.getIQPatternEventAccess().getNameAssignment_1(), "rule__IQPatternEvent__NameAssignment_1");
					put(grammarAccess.getIQPatternEventAccess().getParametersAssignment_3(), "rule__IQPatternEvent__ParametersAssignment_3");
					put(grammarAccess.getIQPatternEventAccess().getIqpatternAssignment_8(), "rule__IQPatternEvent__IqpatternAssignment_8");
					put(grammarAccess.getIQPatternEventAccess().getChangeTypeAssignment_11(), "rule__IQPatternEvent__ChangeTypeAssignment_11");
					put(grammarAccess.getComplexEventAccess().getNameAssignment_1(), "rule__ComplexEvent__NameAssignment_1");
					put(grammarAccess.getComplexEventAccess().getParametersAssignment_3(), "rule__ComplexEvent__ParametersAssignment_3");
					put(grammarAccess.getComplexEventAccess().getPriorityAssignment_8(), "rule__ComplexEvent__PriorityAssignment_8");
					put(grammarAccess.getComplexEventAccess().getComplexEventExpressionsAssignment_11(), "rule__ComplexEvent__ComplexEventExpressionsAssignment_11");
					put(grammarAccess.getRuleAccess().getNameAssignment_1(), "rule__Rule__NameAssignment_1");
					put(grammarAccess.getRuleAccess().getEventsAssignment_5(), "rule__Rule__EventsAssignment_5");
					put(grammarAccess.getRuleAccess().getEventsAssignment_6_1(), "rule__Rule__EventsAssignment_6_1");
					put(grammarAccess.getRuleAccess().getActionAssignment_9(), "rule__Rule__ActionAssignment_9");
					...
					put(grammarAccess.getEventParameterListAccess().getParametersAssignment_1(), "rule__EventParameterList__ParametersAssignment_1");
					put(grammarAccess.getEventParameterListAccess().getParametersAssignment_2_1(), "rule__EventParameterList__ParametersAssignment_2_1");
