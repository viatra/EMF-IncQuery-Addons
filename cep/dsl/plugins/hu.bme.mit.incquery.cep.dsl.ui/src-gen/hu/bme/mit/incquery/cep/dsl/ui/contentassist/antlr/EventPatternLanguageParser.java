...
* generated by Xtext
*/
package hu.bme.mit.incquery.cep.dsl.ui.contentassist.antlr;
...
public class EventPatternLanguageParser extends AbstractContentAssistParser {
	...
	@Override
	protected hu.bme.mit.incquery.cep.dsl.ui.contentassist.antlr.internal.InternalEventPatternLanguageParser createParser() {
		hu.bme.mit.incquery.cep.dsl.ui.contentassist.antlr.internal.InternalEventPatternLanguageParser result = new hu.bme.mit.incquery.cep.dsl.ui.contentassist.antlr.internal.InternalEventPatternLanguageParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getIQPatternEventPatternAccess().getGroup(), "rule__IQPatternEventPattern__Group__0");
					put(grammarAccess.getComplexEventPatternAccess().getGroup(), "rule__ComplexEventPattern__Group__0");
					put(grammarAccess.getComplexEventPatternAccess().getGroup_6(), "rule__ComplexEventPattern__Group_6__0");
					...
					put(grammarAccess.getEventPatternParameterListAccess().getGroup(), "rule__EventPatternParameterList__Group__0");
					put(grammarAccess.getEventPatternParameterListAccess().getGroup_2(), "rule__EventPatternParameterList__Group_2__0");
					put(grammarAccess.getEventTypedParameterAccess().getGroup(), "rule__EventTypedParameter__Group__0");
					put(grammarAccess.getParametrizedIncQueryPatternReferenceAccess().getGroup(), "rule__ParametrizedIncQueryPatternReference__Group__0");
					put(grammarAccess.getParametrizedIncQueryPatternReferenceAccess().getGroup_1(), "rule__ParametrizedIncQueryPatternReference__Group_1__0");
					...
					put(grammarAccess.getMultiplicityExpressionAccess().getGroup(), "rule__MultiplicityExpression__Group__0");
					put(grammarAccess.getTimedMultiplicityExpressionAccess().getGroup(), "rule__TimedMultiplicityExpression__Group__0");
					put(grammarAccess.getFollowsExpressionAccess().getGroup(), "rule__FollowsExpression__Group__0");
					put(grammarAccess.getFollowerExpressionAccess().getGroup(), "rule__FollowerExpression__Group__0");
					put(grammarAccess.getInnerBranchExpressionAccess().getGroup(), "rule__InnerBranchExpression__Group__0");
					...
					put(grammarAccess.getEventModelAccess().getPackagedModelAssignment(), "rule__EventModel__PackagedModelAssignment");
					...
					put(grammarAccess.getIQPatternEventPatternAccess().getIqChangeTypeAssignment_11(), "rule__IQPatternEventPattern__IqChangeTypeAssignment_11");
					...
					put(grammarAccess.getRuleAccess().getEventPatternsAssignment_5(), "rule__Rule__EventPatternsAssignment_5");
					put(grammarAccess.getRuleAccess().getEventPatternsAssignment_6_1(), "rule__Rule__EventPatternsAssignment_6_1");
					put(grammarAccess.getRuleAccess().getActionHandlerAssignment_7_2(), "rule__Rule__ActionHandlerAssignment_7_2");
					put(grammarAccess.getRuleAccess().getActionAssignment_8_1(), "rule__Rule__ActionAssignment_8_1");
					...
					put(grammarAccess.getEventPatternParameterListAccess().getParametersAssignment_1(), "rule__EventPatternParameterList__ParametersAssignment_1");
					put(grammarAccess.getEventPatternParameterListAccess().getParametersAssignment_2_1(), "rule__EventPatternParameterList__ParametersAssignment_2_1");
					put(grammarAccess.getEventTypedParameterAccess().getNameAssignment_1(), "rule__EventTypedParameter__NameAssignment_1");
					put(grammarAccess.getEventTypedParameterAccess().getTypeAssignment_3(), "rule__EventTypedParameter__TypeAssignment_3");
					put(grammarAccess.getParametrizedIncQueryPatternReferenceAccess().getIqpatternAssignment_0(), "rule__ParametrizedIncQueryPatternReference__IqpatternAssignment_0");
					put(grammarAccess.getParametrizedIncQueryPatternReferenceAccess().getParameterListAssignment_1_1(), "rule__ParametrizedIncQueryPatternReference__ParameterListAssignment_1_1");
					put(grammarAccess.getMultiplicityAccess().getMultiplicityAssignment_1(), "rule__Multiplicity__MultiplicityAssignment_1");
					put(grammarAccess.getTimewindowAccess().getLengthAssignment_1(), "rule__Timewindow__LengthAssignment_1");
					put(grammarAccess.getEventTypedParameterWithMultiplicityAccess().getEventPatternAssignment_0(), "rule__EventTypedParameterWithMultiplicity__EventPatternAssignment_0");
					put(grammarAccess.getEventTypedParameterWithMultiplicityAccess().getParameterListAssignment_1_1(), "rule__EventTypedParameterWithMultiplicity__ParameterListAssignment_1_1");
					put(grammarAccess.getEventTypedParameterWithMultiplicityAccess().getMultiplicityAssignment_2(), "rule__EventTypedParameterWithMultiplicity__MultiplicityAssignment_2");
					...
					put(grammarAccess.getTimedExpressionAccess().getExpressionAssignment_1(), "rule__TimedExpression__ExpressionAssignment_1");
					put(grammarAccess.getTimedExpressionAccess().getTimewindowAssignment_3(), "rule__TimedExpression__TimewindowAssignment_3");
					put(grammarAccess.getMultiplicityExpressionAccess().getExpressionAssignment_1(), "rule__MultiplicityExpression__ExpressionAssignment_1");
					put(grammarAccess.getMultiplicityExpressionAccess().getMultiplicityAssignment_3(), "rule__MultiplicityExpression__MultiplicityAssignment_3");
					put(grammarAccess.getTimedMultiplicityExpressionAccess().getExpressionAssignment_1(), "rule__TimedMultiplicityExpression__ExpressionAssignment_1");
					put(grammarAccess.getTimedMultiplicityExpressionAccess().getMultiplicityAssignment_3(), "rule__TimedMultiplicityExpression__MultiplicityAssignment_3");
					put(grammarAccess.getTimedMultiplicityExpressionAccess().getTimewindowAssignment_4(), "rule__TimedMultiplicityExpression__TimewindowAssignment_4");
					put(grammarAccess.getFollowsExpressionAccess().getEventPatternsAssignment_1(), "rule__FollowsExpression__EventPatternsAssignment_1");
					put(grammarAccess.getFollowsExpressionAccess().getFollowerExpressionsAssignment_2(), "rule__FollowsExpression__FollowerExpressionsAssignment_2");
					put(grammarAccess.getFollowerExpressionAccess().getFollowsOperatorAssignment_0(), "rule__FollowerExpression__FollowsOperatorAssignment_0");
					put(grammarAccess.getFollowerExpressionAccess().getEventPatternAssignment_1(), "rule__FollowerExpression__EventPatternAssignment_1");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			hu.bme.mit.incquery.cep.dsl.ui.contentassist.antlr.internal.InternalEventPatternLanguageParser typedParser = (hu.bme.mit.incquery.cep.dsl.ui.contentassist.antlr.internal.InternalEventPatternLanguageParser) parser;
			typedParser.entryRuleEventModel();
