...
import hu.bme.mit.incquery.cep.performance.md.patterns.util.ComponentAQuerySpecification;
...
/**
 * Generated pattern matcher API of the hu.bme.mit.incquery.cep.performance.md.patterns.componentA pattern, 
...
public class ComponentAMatcher extends BaseMatcher<ComponentAMatch> {
   ...
   * 
   */
  public Collection<ComponentAMatch> getAllMatches(final TransactionComponentA pTe) {
   ...
   * 
   */
  public ComponentAMatch getOneArbitraryMatch(final TransactionComponentA pTe) {
   ...
   * 
   */
  public void forEachMatch(final TransactionComponentA pTe, final IMatchProcessor<? super ComponentAMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final TransactionComponentA pTe, final IMatchProcessor<? super ComponentAMatch> processor) {
   ...
   */
  @Deprecated
  public DeltaMonitor<ComponentAMatch> newFilteredDeltaMonitor(final boolean fillAtStart, final TransactionComponentA pTe) {
   ...
   * 
   */
  public ComponentAMatch newMatch(final TransactionComponentA pTe) {
    return new ComponentAMatch.Immutable(pTe);
  ...
  protected ComponentAMatch tupleToMatch(final Tuple t) {
    try {
    	return new ComponentAMatch.Immutable((hu.bme.mit.incquery.cep.performance.md.metamodels.performancetransaction.TransactionComponentA) t.get(POSITION_TE));	
  ...
  protected ComponentAMatch arrayToMatch(final Object[] match) {
    try {
    	return new ComponentAMatch.Immutable((hu.bme.mit.incquery.cep.performance.md.metamodels.performancetransaction.TransactionComponentA) match[POSITION_TE]);
  ...
  protected ComponentAMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return new ComponentAMatch.Mutable((hu.bme.mit.incquery.cep.performance.md.metamodels.performancetransaction.TransactionComponentA) match[POSITION_TE]);
    } catch(ClassCastException e) {engine.getLogger().error("Element(s) in array not properly typed!",e);	//throw new IncQueryRuntimeException(e.getMessage());
    	return null;
    }
