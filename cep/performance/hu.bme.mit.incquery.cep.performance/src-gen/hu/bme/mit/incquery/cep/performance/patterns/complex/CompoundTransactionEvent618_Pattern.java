...
public class CompoundTransactionEvent618_Pattern extends ParameterizableComplexEventPattern {
  public CompoundTransactionEvent618_Pattern() {
    super();
    ...
    setId("CompoundTransactionEvent618_Pattern");
  }
