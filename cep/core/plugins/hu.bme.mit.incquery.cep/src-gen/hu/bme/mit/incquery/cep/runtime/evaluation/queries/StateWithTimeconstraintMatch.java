...
/**
 * Pattern-specific match representation of the hu.bme.mit.incquery.cep.runtime.evaluation.queries.stateWithTimeconstraint pattern, 
 * to be used in conjunction with {@link StateWithTimeconstraintMatcher}.
 * 
...
public abstract class StateWithTimeconstraintMatch extends BasePatternMatch {
  ...
  private StateWithTimeconstraintMatch(final State pS, final TimeConstraint pTc) {
    this.fS = pS;
    this.fTc = pTc;
  ...
  public List<String> parameterNames() {
    return StateWithTimeconstraintMatch.parameterNames;
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof StateWithTimeconstraintMatch)) { // this should be infrequent				
    	if (obj == null)
    		return false;
    ...
    StateWithTimeconstraintMatch other = (StateWithTimeconstraintMatch) obj;
  ...
  public Pattern pattern() {
    try {
    	return StateWithTimeconstraintMatcher.querySpecification().getPattern();
