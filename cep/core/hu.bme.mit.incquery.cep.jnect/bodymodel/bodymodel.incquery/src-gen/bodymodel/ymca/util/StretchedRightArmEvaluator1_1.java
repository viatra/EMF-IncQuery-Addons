...
public class StretchedRightArmEvaluator1_1 implements IMatchChecker {
   ...
   */
  private Boolean evaluateXExpressionGenerated(final Float RSY, final Float RHZ, final Float RHY, final Float RHX, final Float RSX, final Float REY, final Float RSZ, final Float REX, final Float REZ) {
  ...
  public Boolean evaluateXExpression(final Tuple tuple, final Map<String,Integer> tupleNameMap) {
    ...
    return evaluateXExpressionGenerated(RSY, RHZ, RHY, RHX, RSX, REY, RSZ, REX, REZ);
  }
}
