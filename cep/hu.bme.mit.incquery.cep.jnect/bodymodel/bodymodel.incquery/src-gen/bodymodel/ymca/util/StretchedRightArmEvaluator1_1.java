...
public class StretchedRightArmEvaluator1_1 implements IMatchChecker {
   ...
   */
  private Boolean evaluateXExpressionGenerated(final Float REX, final Float RHZ, final Float RSZ, final Float RSX, final Float REY, final Float RHX, final Float REZ, final Float RHY, final Float RSY) {
  ...
  public Boolean evaluateXExpression(final Tuple tuple, final Map<String,Integer> tupleNameMap) {
    ...
    return evaluateXExpressionGenerated(REX, RHZ, RSZ, RSX, REY, RHX, REZ, RHY, RSY);
  }
}
