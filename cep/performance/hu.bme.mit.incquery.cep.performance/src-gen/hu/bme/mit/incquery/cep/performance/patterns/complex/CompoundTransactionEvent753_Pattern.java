...
public class CompoundTransactionEvent753_Pattern extends ParameterizableComplexEventPattern {
  public CompoundTransactionEvent753_Pattern() {
    super();
    ...
    setId("CompoundTransactionEvent753_Pattern");
  }
