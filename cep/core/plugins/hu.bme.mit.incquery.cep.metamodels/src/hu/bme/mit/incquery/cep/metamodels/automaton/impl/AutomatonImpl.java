 ...
 * <ul>
 *   <li>{@link hu.bme.mit.incquery.cep.metamodels.automaton.impl.AutomatonImpl#getStates <em>States</em>}</li>
 *   <li>{@link hu.bme.mit.incquery.cep.metamodels.automaton.impl.AutomatonImpl#getEventPattern <em>Event Pattern</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
    ...
    public void setEventPattern(EventPattern newEventPattern) {
        if (newEventPattern != eventPattern) {
            ...
            if (eventPattern != null)
                msgs = ((InternalEObject)eventPattern).eInverseRemove(this, CepPackage.EVENT_PATTERN__AUTOMATON, EventPattern.class, msgs);
            if (newEventPattern != null)
                msgs = ((InternalEObject)newEventPattern).eInverseAdd(this, CepPackage.EVENT_PATTERN__AUTOMATON, EventPattern.class, msgs);
