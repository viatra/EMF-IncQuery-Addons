...
public class CepSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case CepPackage.COMPLEX_EVENT_PATTERN: {
			...
			case CepPackage.EVENT: {
				Event event = (Event)theEObject;
				T result = caseEvent(event);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CepPackage.IEVENT_SOURCE: {
				IEventSource iEventSource = (IEventSource)theEObject;
				T result = caseIEventSource(iEventSource);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CepPackage.TIMEWINDOW: {
				Timewindow timewindow = (Timewindow)theEObject;
				T result = caseTimewindow(timewindow);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CepPackage.PARTIAL_TIMEWINDOW: {
				PartialTimewindow partialTimewindow = (PartialTimewindow)theEObject;
				T result = casePartialTimewindow(partialTimewindow);
				if (result == null) result = caseTimewindow(partialTimewindow);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CepPackage.GLOBAL_TIMEWINDOW: {
				GlobalTimewindow globalTimewindow = (GlobalTimewindow)theEObject;
				T result = caseGlobalTimewindow(globalTimewindow);
				if (result == null) result = caseTimewindow(globalTimewindow);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Partial Timewindow</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Partial Timewindow</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePartialTimewindow(PartialTimewindow object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Global Timewindow</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Global Timewindow</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseGlobalTimewindow(GlobalTimewindow object) {
		return null;
	}
