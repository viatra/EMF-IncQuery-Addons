...
/**
 * Pattern-specific match representation of the bodymodel.ymca.SM pattern, 
 * to be used in conjunction with {@link SMMatcher}.
 * 
 ...
 * 
 */
public abstract class SMMatch extends BasePatternMatch {
  ...
  private SMMatch(final RightHand pRH, final RightElbow pRE, final RightShoulder pRS) {
    this.fRH = pRH;
    this.fRE = pRE;
    this.fRS = pRS;
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof SMMatch)) { // this should be infrequent				
    	if (obj == null)
    		return false;
  ...
  public Pattern pattern() {
    try {
    	return SMMatcher.querySpecification().getPattern();
  ...
  static final class Mutable extends SMMatch {
  ...
  static final class Immutable extends SMMatch {
