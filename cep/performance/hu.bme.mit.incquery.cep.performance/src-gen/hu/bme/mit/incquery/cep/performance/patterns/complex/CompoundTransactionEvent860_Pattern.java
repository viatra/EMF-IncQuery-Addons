...
public class CompoundTransactionEvent860_Pattern extends ParameterizableComplexEventPattern {
  public CompoundTransactionEvent860_Pattern() {
    super();
    ...
    setId("CompoundTransactionEvent860_Pattern");
  }
