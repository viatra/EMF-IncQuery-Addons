...
public class UpperArmsInYEvaluator1_1 implements IMatchChecker {
   ...
   */
  private Boolean evaluateXExpressionGenerated(final Float LSY, final Float LEY, final Float LEZ, final Float LSX, final Float RSZ, final Float RSX, final Float REZ, final Float LEX, final Float LSZ, final Float RSY, final Float REX, final Float REY) {
  ...
  public Boolean evaluateXExpression(final Tuple tuple, final Map<String,Integer> tupleNameMap) {
    ...
    return evaluateXExpressionGenerated(LSY, LEY, LEZ, LSX, RSZ, RSX, REZ, LEX, LSZ, RSY, REX, REY);
  }
}
