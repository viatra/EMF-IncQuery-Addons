...
/**
 * A xbase xexpression evaluator tailored for the hu.bme.mit.incquery.cep.casestudy.transaction.incquery.patterns.sample.oldCompoundTransaction pattern.
 */
@SuppressWarnings("all")
public class OldCompoundTransactionEvaluator1_1 implements IMatchChecker {
  /**
   * The raw java code generated from the xbase xexpression by xtext.
   */
  private Boolean evaluateXExpressionGenerated(final Long ts) {
    boolean _greaterThan = ((ts).longValue() > 1000l);
