...
public class StretchedLeftArmEvaluator1_1 implements IMatchChecker {
   ...
   */
  private Boolean evaluateXExpressionGenerated(final Float LSZ, final Float LSY, final Float LEZ, final Float LSX, final Float LEY, final Float LHZ, final Float LEX, final Float LHX, final Float LHY) {
  ...
  public Boolean evaluateXExpression(final Tuple tuple, final Map<String,Integer> tupleNameMap) {
    ...
    return evaluateXExpressionGenerated(LSZ, LSY, LEZ, LSX, LEY, LHZ, LEX, LHX, LHY);
  }
}
