...
import bodymodel.ymca.MMatch;
import bodymodel.ymca.util.MQuerySpecification;
...
/**
 * Generated pattern matcher API of the bodymodel.ymca.M pattern, 
 * providing pattern-specific query methods.
 * 
 * <p>Use the pattern matcher on a given model via {@link #on(IncQueryEngine)}, 
 * e.g. in conjunction with {@link IncQueryEngine#on(Notifier)}.
 * 
 * <p>Matches of the pattern will be represented as {@link MMatch}.
 * 
 * <p>Original source:
 * <code><pre>
 ...
 * 		- MovingAverageCalculator::getCalculator("LSY").addValue(LSY).movingAvg) {@literal <} YMCAConstants::veryCloseDistance);
 * 	RightElbow.y(RE,REY);
 * 	RightShoulder.y(RS,RSY);
 * 	check(Math::abs(MovingAverageCalculator::getCalculator("REY").addValue(REY).movingAvg
 * 		- MovingAverageCalculator::getCalculator("RSY").addValue(RSY).movingAvg) {@literal <} YMCAConstants::veryCloseDistance);	
 * 	// hands are apart
 ...
 * @see MMatch
 * @see MProcessor
 * @see MQuerySpecification
 * 
 */
public class MMatcher extends BaseMatcher<MMatch> {
  /**
   ...
   * 
   */
  public static MMatcher on(final IncQueryEngine engine) throws IncQueryException {
    // check if matcher already exists
    MMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = new MMatcher(engine);
   ...
   */
  @Deprecated
  public MMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   */
  @Deprecated
  public MMatcher(final IncQueryEngine engine) throws IncQueryException {
   ...
   * @return matches represented as a MMatch object.
   * 
   */
  public Collection<MMatch> getAllMatches(final RightHand pRH, final RightElbow pRE, final RightShoulder pRS, final LeftHand pLH, final LeftElbow pLE, final LeftShoulder pLS, final Head pH) {
   ...
   * @param pLS the fixed value of pattern parameter LS, or null if not bound.
   * @param pH the fixed value of pattern parameter H, or null if not bound.
   * @return a match represented as a MMatch object, or null if no match is found.
   * 
   */
  public MMatch getOneArbitraryMatch(final RightHand pRH, final RightElbow pRE, final RightShoulder pRS, final LeftHand pLH, final LeftElbow pLE, final LeftShoulder pLS, final Head pH) {
   ...
   * 
   */
  public void forEachMatch(final RightHand pRH, final RightElbow pRE, final RightShoulder pRS, final LeftHand pLH, final LeftElbow pLE, final LeftShoulder pLS, final Head pH, final IMatchProcessor<? super MMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final RightHand pRH, final RightElbow pRE, final RightShoulder pRS, final LeftHand pLH, final LeftElbow pLE, final LeftShoulder pLS, final Head pH, final IMatchProcessor<? super MMatch> processor) {
   ...
   */
  @Deprecated
  public DeltaMonitor<MMatch> newFilteredDeltaMonitor(final boolean fillAtStart, final RightHand pRH, final RightElbow pRE, final RightShoulder pRS, final LeftHand pLH, final LeftElbow pLE, final LeftShoulder pLS, final Head pH) {
   ...
   * 
   */
  public MMatch newMatch(final RightHand pRH, final RightElbow pRE, final RightShoulder pRS, final LeftHand pLH, final LeftElbow pLE, final LeftShoulder pLS, final Head pH) {
    return new MMatch.Immutable(pRH, pRE, pRS, pLH, pLE, pLS, pH);
   ...
   * 
   */
  public Set<RightHand> getAllValuesOfRH(final MMatch partialMatch) {
   ...
   * 
   */
  public Set<RightElbow> getAllValuesOfRE(final MMatch partialMatch) {
   ...
   * 
   */
  public Set<RightShoulder> getAllValuesOfRS(final MMatch partialMatch) {
   ...
   * 
   */
  public Set<LeftHand> getAllValuesOfLH(final MMatch partialMatch) {
   ...
   * 
   */
  public Set<LeftElbow> getAllValuesOfLE(final MMatch partialMatch) {
   ...
   * 
   */
  public Set<LeftShoulder> getAllValuesOfLS(final MMatch partialMatch) {
   ...
   * 
   */
  public Set<Head> getAllValuesOfH(final MMatch partialMatch) {
  ...
  @Override
  protected MMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return new MMatch.Mutable((org.jnect.bodymodel.RightHand) match[POSITION_RH], (org.jnect.bodymodel.RightElbow) match[POSITION_RE], (org.jnect.bodymodel.RightShoulder) match[POSITION_RS], (org.jnect.bodymodel.LeftHand) match[POSITION_LH], (org.jnect.bodymodel.LeftElbow) match[POSITION_LE], (org.jnect.bodymodel.LeftShoulder) match[POSITION_LS], (org.jnect.bodymodel.Head) match[POSITION_H]);
    } catch(ClassCastException e) {engine.getLogger().error("Element(s) in array not properly typed!",e);	//throw new IncQueryRuntimeException(e.getMessage());
    	return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<MMatcher> querySpecification() throws IncQueryException {
    return MQuerySpecification.instance();
  }
}
