 ...
 * <ul>
 *   <li>{@link hu.bme.mit.incquery.vedl.edl.impl.ParameterFilterImpl#getAttributeName <em>Attribute Name</em>}</li>
 *   <li>{@link hu.bme.mit.incquery.vedl.edl.impl.ParameterFilterImpl#getParamFilterRule <em>Param Filter Rule</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ParameterFilterImpl extends MinimalEObjectImpl.Container implements ParameterFilter
{
  ...
  {
    return EdlPackage.Literals.PARAMETER_FILTER;
  }
  ...
  public void setAttributeName(String newAttributeName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EdlPackage.PARAMETER_FILTER__ATTRIBUTE_NAME, oldAttributeName, attributeName));
  }
  ...
  public NotificationChain basicSetParamFilterRule(ParameterFilterRule newParamFilterRule, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EdlPackage.PARAMETER_FILTER__PARAM_FILTER_RULE, oldParamFilterRule, newParamFilterRule);
  ...
  public void setParamFilterRule(ParameterFilterRule newParamFilterRule)
  {
    if (newParamFilterRule != paramFilterRule)
    {
      ...
      if (paramFilterRule != null)
        msgs = ((InternalEObject)paramFilterRule).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EdlPackage.PARAMETER_FILTER__PARAM_FILTER_RULE, null, msgs);
      if (newParamFilterRule != null)
        msgs = ((InternalEObject)newParamFilterRule).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EdlPackage.PARAMETER_FILTER__PARAM_FILTER_RULE, null, msgs);
      msgs = basicSetParamFilterRule(newParamFilterRule, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EdlPackage.PARAMETER_FILTER__PARAM_FILTER_RULE, newParamFilterRule, newParamFilterRule));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case EdlPackage.PARAMETER_FILTER__PARAM_FILTER_RULE:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case EdlPackage.PARAMETER_FILTER__ATTRIBUTE_NAME:
