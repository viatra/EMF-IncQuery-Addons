...
/**
 * Pattern-specific match representation of the bodymodel.ymca.BS pattern, 
 * to be used in conjunction with {@link BSMatcher}.
 * 
 ...
 * 
 */
public abstract class BSMatch extends BasePatternMatch {
  ...
  private static List<String> parameterNames = makeImmutableList("LH", "LE", "LS", "H");
  
  private BSMatch(final LeftHand pLH, final LeftElbow pLE, final LeftShoulder pLS, final Head pH) {
    this.fLH = pLH;
    this.fLE = pLE;
    this.fLS = pLS;
    this.fH = pH;
  ...
  public List<String> parameterNames() {
    return BSMatch.parameterNames;
    
  }
  
  @Override
  public Object[] toArray() {
    return new Object[]{fLH, fLE, fLS, fH};
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof BSMatch)) { // this should be infrequent				
    	if (obj == null)
    		return false;
  ...
  public Pattern pattern() {
    try {
    	return BSMatcher.querySpecification().getPattern();
  ...
  static final class Mutable extends BSMatch {
    Mutable(final LeftHand pLH, final LeftElbow pLE, final LeftShoulder pLS, final Head pH) {
      super(pLH, pLE, pLS, pH);
  ...
  static final class Immutable extends BSMatch {
    Immutable(final LeftHand pLH, final LeftElbow pLE, final LeftShoulder pLS, final Head pH) {
      super(pLH, pLE, pLS, pH);
