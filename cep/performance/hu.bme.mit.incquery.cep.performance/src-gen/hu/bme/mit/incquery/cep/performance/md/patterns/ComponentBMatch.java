...
/**
 * Pattern-specific match representation of the hu.bme.mit.incquery.cep.performance.md.patterns.componentB pattern, 
...
public abstract class ComponentBMatch extends BasePatternMatch {
  ...
  private ComponentBMatch(final TransactionComponentB pTe) {
    this.fTe = pTe;
  ...
  public boolean set(final String parameterName, final Object newValue) {
    ...
    if ("te".equals(parameterName) ) {
    	this.fTe = (hu.bme.mit.incquery.cep.performance.md.metamodels.performancetransaction.TransactionComponentB) newValue;
    	return true;
    }
    return false;
  ...
  public String patternName() {
    return "hu.bme.mit.incquery.cep.performance.md.patterns.componentB";
